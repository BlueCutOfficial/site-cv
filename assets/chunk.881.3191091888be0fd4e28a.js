/*! For license information please see chunk.881.3191091888be0fd4e28a.js.LICENSE.txt */
...
return F(this,n)}}function F(e,t){if(t&&("object"===o(t)||"function"==typeof t))return t
...
B(Ot,{DqElement:function(){return or},aggregate:function(){return dn},aggregateChecks:function(){return vn},aggregateNodeResults:function(){return yn},aggregateResult:function(){return Dn},areStylesSet:function(){return xn},assert:function(){return Pt},checkHelper:function(){return ir},clone:function(){return sr},closest:function(){return xr},collectResultsFromFrames:function(){return qr},contains:function(){return Lr},convertSelector:function(){return br},cssParser:function(){return ur},deepMerge:function(){return Br},escapeSelector:function(){return An},extendMetaData:function(){return Ur},filterHtmlAttrs:function(){return ki},finalizeRuleResult:function(){return bn},findBy:function(){return Pr},getAllChecks:function(){return Ir},getAncestry:function(){return Jn},getBaseLang:function(){return go},getCheckMessage:function(){return Ao},getCheckOption:function(){return Co},getEnvironmentData:function(){return ko},getFlattenedTree:function(){return mo},getFrameContexts:function(){return Io},getFriendlyUriEnd:function(){return _n},getNodeAttributes:function(){return On},getNodeFromTree:function(){return nr},getPreloadConfig:function(){return yi},getRootNode:function(){return $r},getRule:function(){return Po},getScroll:function(){return jo},getScrollState:function(){return Lo},getSelector:function(){return Qn},getSelectorData:function(){return Vn},getShadowSelector:function(){return Pn},getStandards:function(){return Bo},getStyleSheetFactory:function(){return Ho},getXpath:function(){return Zn},injectStyle:function(){return Vo},isHidden:function(){return zo},isHtmlElement:function(){return $o},isNodeInContext:function(){return Go},isShadowRoot:function(){return Vr},isValidLang:function(){return ji},isXHTML:function(){return In},matchAncestry:function(){return Yo},matches:function(){return Dr},matchesExpression:function(){return wr},matchesSelector:function(){return Sn},memoize:function(){return Ko},mergeResults:function(){return Mr},nodeSorter:function(){return Jo},parseCrossOriginStylesheet:function(){return oi},parseSameOriginStylesheet:function(){return Xo},parseStylesheet:function(){return ai},performanceTimer:function(){return si},pollyfillElementsFromPoint:function(){return li},preload:function(){return wi},preloadCssom:function(){return fi},preloadMedia:function(){return vi},processMessage:function(){return Eo},publishMetaData:function(){return xi},querySelectorAll:function(){return Ei},querySelectorAllFilter:function(){return pi},queue:function(){return Fr},respondable:function(){return Nr},ruleShouldRun:function(){return Ci},select:function(){return Ti},sendCommandToFrame:function(){return _r},setScrollState:function(){return Ni},shadowSelect:function(){return Ri},shouldPreload:function(){return bi},toArray:function(){return En},tokenList:function(){return Oi},uniqueArray:function(){return ui},uuid:function(){return rn},validInputTypes:function(){return Si},validLangs:function(){return Pi}})
...
Bt=function(){return Ht.getRandomValues(Vt),Vt}}if(!Bt){var zt=new Array(16)
Bt=function(){for(var e,t=0;t<16;t++)0==(3&t)&&(e=4294967296*Math.random()),zt[t]=e>>>((3&t)<<3)&255
return zt}}for(var $t="function"==typeof n.Buffer?n.Buffer:Array,Wt=[],Gt={},Yt=0;Yt<256;Yt++)Wt[Yt]=(Yt+256).toString(16).substr(1),Gt[Wt[Yt]]=Yt
function Qt(e,t){var n=t||0,r=Wt
return r[e[n++]]+r[e[n++]]+r[e[n++]]+r[e[n++]]+"-"+r[e[n++]]+r[e[n++]]+"-"+r[e[n++]]+r[e[n++]]+"-"+r[e[n++]]+r[e[n++]]+"-"+r[e[n++]]+r[e[n++]]+r[e[n++]]+r[e[n++]]+r[e[n++]]+r[e[n++]]}var Kt=Bt(),Jt=[1|Kt[0],Kt[1],Kt[2],Kt[3],Kt[4],Kt[5]],Xt=16383&(Kt[6]<<8|Kt[7]),Zt=0,en=0
function tn(e,t,n){var r=t&&n||0,a=t||[],o=null!=(e=e||{}).clockseq?e.clockseq:Xt,i=null!=e.msecs?e.msecs:(new Date).getTime(),s=null!=e.nsecs?e.nsecs:en+1,l=i-Zt+(s-en)/1e4
...
for(var d=e.node||Jt,p=0;p<6;p++)a[r+p]=d[p]
return t||Qt(a)}function nn(e,t,n){var r=t&&n||0
"string"==typeof e&&(t="binary"==e?new $t(16):null,e=null)
...
return t},Lt.unparse=Qt,Lt.BufferClass=$t,i._uuid=tn()
var rn=nn,an=[]
...
return r instanceof Error?a.error={name:r.name,message:r.message,stack:r.stack}:a.payload=r,JSON.stringify(a)}(S({messageId:on()},t)),o=i._audit.allowedOrigins
...
jt(l),t(u,f)}else!function(e,t){var n=t.channelId,r=t.message,a=t.keepalive,o=function(e){return Ut[e]}(n)||{},s=o.replyHandler,l=o.sendToParent
if(s){l?jt(e):Mt(e)
var u=ln(e,n,l)
...
return e[r.pop()]},pn=Tt.CANTTELL_PRIO,fn=Tt.FAIL_PRIO,hn=[]
hn[Tt.PASS_PRIO]=!0,hn[Tt.CANTTELL_PRIO]=null,hn[Tt.FAIL_PRIO]=!1
var mn=["any","all","none"]
...
var r=[]
return mn.forEach((function(e){t[e]=t[e].filter((function(r){return r.priority===t.priority&&r.priority===n[e]})),t[e].forEach((function(e){return r.push(e.impact)}))})),[pn,fn].includes(t.priority)?t.impact=dn(Tt.impact,r):t.impact=null,gn(t,(function(e){delete e.result,delete e.priority})),t.result=Tt.results[t.priority],delete t.priority,t},bn=function(e){var t=i._audit.rules.find((function(t){return t.id===e.id}))
return t&&t.impact&&e.nodes.forEach((function(e){["any","all","none"].forEach((function(n){(e[n]||[]).forEach((function(e){e.impact=t.impact}))}))})),Object.assign(e,yn(e.nodes)),delete e.nodes,e},yn=function(e){var t={}
...
t.result=dn(Tt.results,n,t.result)}else t.result="inapplicable"
...
t.impact=dn(Tt.impact,a)||null}else t.impact=null
return t}
function wn(e,t,n){var r=Object.assign({},t)
r.nodes=(r[n]||[]).concat(),Tt.resultGroups.forEach((function(e){delete r[e]})),e[n].push(r)}var Dn=function(e){var t={}
return Tt.resultGroups.forEach((function(e){return t[e]=[]})),e.forEach((function(e){e.error?wn(t,e,Tt.CANTTELL_GROUP):e.result===Tt.NA?wn(t,e,Tt.NA_GROUP):Tt.resultGroups.forEach((function(n){Array.isArray(e[n])&&e[n].length>0&&wn(t,e,n)}))})),t},xn=function e(t,r,a){var o=n.getComputedStyle(t,null)
if(!o)return!1
...
return 0!==e.length&&(e.match(/[0-9]/g)||"").length>=e.length/2}function kn(e,t){return[e.substring(0,t),e.substring(t)]}function Fn(e){return e.replace(/\s+$/,"")}function Tn(e){var t=e,n="",r="",a="",o="",i=""
...
r=p[0],a=p[1]}return{original:t,protocol:n,domain:r,port:a,path:e,query:o,hash:i}}var Nn,Rn,_n=function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:"",t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{}
if(!(e.length<=1||"data:"===e.substr(0,5)||"javascript:"===e.substr(0,11)||e.includes("?"))){var n=t.currentDomain,r=t.maxLength,a=void 0===r?25:r,o=Tn(e),i=o.path,s=o.domain,l=o.hash,u=i.substr(i.substr(0,i.length-2).lastIndexOf("/")+1)
if(l)return u&&(u+l).length<=a?Fn(u+l):u.length<2&&l.length>2&&l.length<=a?Fn(l):void 0
if(s&&s.length<a&&i.length<=1)return Fn(s+i)
if(i==="/"+u&&s&&n&&s!==n&&(s+i).length<=a)return Fn(s+i)
var c=u.lastIndexOf(".")
return(-1===c||c>1)&&(-1!==c||u.length>2)&&u.length<=a&&!u.match(/index(\.[a-zA-Z]{2-4})?/)&&!Cn(u)?Fn(u):void 0}},On=function(e){return e.attributes instanceof n.NamedNodeMap?e.attributes:e.cloneNode(!1).attributes},Sn=function(e,t){return Nn&&e[Nn]||(Nn=function(e){var t,n,r=["matches","matchesSelector","mozMatchesSelector","webkitMatchesSelector","msMatchesSelector"],a=r.length
for(t=0;t<a;t++)if(e[n=r[t]])return n}(e)),!!e[Nn]&&e[Nn](t)},In=function(e){return!!e.createElement&&"A"===e.createElement("A").localName},Pn=function(e,t){var n=arguments.length>2&&void 0!==arguments[2]?arguments[2]:{}
if(!t)return""
...
return n}function Un(e,t){return e.count<t.count?-1:e.count===t.count?0:1}function Hn(e){return!jn.includes(e.name)&&-1===e.name.indexOf(":")&&(!e.value||e.value.length<31)}function Vn(e){for(var t={classes:{},tags:{},attributes:{}},n=(e=Array.isArray(e)?e:[e]).slice(),r=[],a=function(){var e=n.pop(),a=e.actualNode
...
t.classes[n]?t.classes[n]++:t.classes[n]=1})),a.hasAttributes()&&Array.from(On(a)).filter(Hn).forEach((function(e){var n=Bn(a,e)
...
return n.find((function(n){return n!==e&&Sn(n,t)}))?":nth-child("+(1+n.indexOf(e))+")":""}function $n(e){if(e.getAttribute("id")){var t=e.getRootNode&&e.getRootNode()||a,n="#"+An(e.getAttribute("id")||"")
...
r[o]<a[e.nodeName]&&n.push({name:o,count:r[o],species:"class"})})),n.sort(Un)}(e,t),o=function(e,t){var n=[],r=t.attributes,a=t.tags
return e.hasAttributes()&&Array.from(On(e)).filter(Hn).forEach((function(t){var o=Bn(e,t)
o&&r[o]<a[e.nodeName]&&n.push({name:o,count:r[o],species:"attribute"})})),n.sort(Un)}(e,t)
return a.length&&1===a[0].count?n=[a[0]]:o.length&&1===o[0].count?(n=[o[0]],r=Wn(e)):((n=a.concat(o)).sort(Un),(n=n.slice(0,3)).some((function(e){return"class"===e.species}))?n.sort((function(e,t){return e.species!==t.species&&"class"===e.species?-1:e.species===t.species?0:1})):r=Wn(e)),r+n.reduce((function(e,t){switch(t.species){case"class":return e+"."+t.name
...
do{var l=$n(e)
l||(l=Gn(e,i._selectorData),l+=zn(e,l)),r=r?l+" > "+r:l,a=a?a.filter((function(e){return Sn(e,r)})):Array.from(n.querySelectorAll(r)),e=e.parentElement}while((a.length>1||s)&&e&&11!==e.nodeType)
return 1===a.length?r:-1!==r.indexOf(" > ")?":root"+r.substring(r.indexOf(" > ")):":root"}function Qn(e,t){return Pn(Yn,e,t)}function Kn(e){var t=e.nodeName.toLowerCase(),n=e.parentElement
if(!n)return t
var r=""
if("head"!==t&&"body"!==t&&n.children.length>1){var a=Array.prototype.indexOf.call(n.children,e)+1
r=":nth-child(".concat(a,")")}return Kn(n)+" > "+t+r}function Jn(e,t){return Pn(Kn,e,t)}function Xn(e,t){var n,r
if(!e)return[]
...
return l},lr=new(U($()).CssSelectorParser)
...
return t}))}function br(e){var t=ur.parse(e)
return vr(t=t.selectors?t.selectors:[t])}function yr(e,t,n,r){for(var a=Array.isArray(t)?t[n]:t,o=cr(e,a);!o&&r&&e.parent;)o=cr(e=e.parent,a)
...
o=o&&yr(e.parent,t,n-1," "===a.combinator)}return o}function wr(e,t,n){return yr(e,t,t.length-1,n)}var Dr=function(e,t){return br(t).some((function(t){return wr(e,t)}))},xr=function(e,t){for(;e;){if(Dr(e,t))return e
if(void 0===e.parent)throw new TypeError("Cannot resolve parent for non-DOM nodes")
e=e.parent}return null}
function Er(){}function Ar(e){if("function"!=typeof e)throw new TypeError("Queue methods require functions as arguments")}var Cr,kr,Fr=function(){var e,t=[],n=0,r=0,a=Er,i=!1,s=function(t){e=t,setTimeout((function(){null!=e&&Nt("Uncaught error (of queue)",e)}),1)},l=s
...
return d},Tr={}
function Nr(e,t,n,r,a){var o={topic:t,message:n,channelId:"".concat(nn(),":").concat(nn()),keepalive:r}
return kr(e,o,a)}function Rr(e,t){var n=e.topic,r=e.message,a=e.keepalive,o=Tr[n]
...
if(0!==s){var l=setTimeout((function(){l=setTimeout((function(){t.debug?r(Sr("No response from frame",e)):n(null)}),0)}),s)
Nr(i,"axe.ping",null,void 0,(function(){clearTimeout(l),Or(e,t,n,r)}))}else Or(e,t,n,r)}function Or(e,t,n,r){var a,o,i=null!==(a=null===(o=t.options)||void 0===o?void 0:o.frameWaitTime)&&void 0!==a?a:6e4,s=e.contentWindow,l=setTimeout((function(){r(Sr("Axe in frame timed out",e))}),i)
Nr(s,"axe.start",t,void 0,(function(e){clearTimeout(l),e instanceof Error==0?n(e):r(e)}))}function Sr(e,t){var n
return i._tree&&(n=Qn(t)),new Error(e+": "+(n||t))}Nr.updateMessenger=function(e){var t=e.open,n=e.post
Pt("function"==typeof t,"open callback must be a function"),Pt("function"==typeof n,"post callback must be a function"),Cr&&Cr()
var r=t(Rr)
r?(Pt("function"==typeof r,"open callback must return a cleanup function"),Cr=r):Cr=null,kr=n},Nr.subscribe=function(e,t){Pt("function"==typeof t,"Subscriber callback must be a function"),Pt(!Tr[e],"Topic ".concat(e," is already registered to.")),Tr[e]=t},Nr.isInFrame=function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:n
return!!e.frameElement},cn(Nr)
...
if(o>0||0===o&&n.selector.length<a.selector.length)return void e.splice.apply(e,[r,0].concat(_(t)))}e.push.apply(e,_(t))}(r.nodes,e.nodes):n.push(e)}))}})),n.forEach((function(e){e.nodes&&e.nodes.sort((function(e,t){return jr(e.node.nodeIndexes,t.node.nodeIndexes)}))})),n}
function qr(e,t,n,r,a,o){var i=Fr()
...
try{e[n]=t[n](e)}catch(e){}}))},Hr=["article","aside","blockquote","body","div","footer","h1","h2","h3","h4","h5","h6","header","main","nav","p","section","span"],Vr=function(e){if(e.shadowRoot){var t=e.nodeName.toLowerCase()
if(Hr.includes(t)||/^[a-z][a-z0-9_.-]*-[a-z0-9_.-]*$/.test(t))return!0}return!1},zr={}
B(zr,{findElmsInContext:function(){return Gr},findUp:function(){return Qr},findUpVirtual:function(){return Yr},getComposedParent:function(){return Kr},getElementByReference:function(){return ea},getElementCoordinates:function(){return na},getElementStack:function(){return va},getRootNode:function(){return Wr},getScrollOffset:function(){return ta},getTabbableElements:function(){return ba},getTextElementStack:function(){return wa},getViewportSize:function(){return ra},hasContent:function(){return Ta},hasContentVirtual:function(){return Fa},idrefs:function(){return Ea},insertedIntoFocusOrder:function(){return Pa},isCurrentPageLink:function(){return Zr},isFocusable:function(){return Ia},isHTML5:function(){return ja},isHiddenWithCSS:function(){return _a},isInTextBlock:function(){return Ba},isModalOpen:function(){return Ua},isNativelyFocusable:function(){return Sa},isNode:function(){return Ha},isOffscreen:function(){return aa},isOpaque:function(){return Za},isSkipLink:function(){return eo},isVisible:function(){return sa},isVisualContent:function(){return xa},reduceToElementsBelowFloating:function(){return to},shadowElementsFromPoint:function(){return oo},urlPropsFromAttribute:function(){return uo},visuallyContains:function(){return no},visuallyOverlaps:function(){return co}})
var $r=function(e){var t=e.getRootNode&&e.getRootNode()||a
return t===e&&(t=a),t},Wr=$r,Gr=function(e){var t,n=e.context,r=e.value,a=e.attr,o=e.elm,i=void 0===o?"":o,s=An(r)
...
do{(n=n.assignedSlot?n.assignedSlot:n.parentNode)&&11===n.nodeType&&(n=n.host)}while(n&&!Sn(n,t)&&n!==a.documentElement)
return n&&Sn(n,t)?n:null},Qr=function(e,t){return Yr(nr(e),t)},Kr=function e(t){if(t.assignedSlot)return e(t.assignedSlot)
if(t.parentNode){var n=t.parentNode
if(1===n.nodeType)return n
if(n.host)return n.host}return null},Jr=/^\/\#/,Xr=/^#[!/]/
function Zr(e){var t,r=e.getAttribute("href")
if(!r||"#"===r)return!1
if(Jr.test(r))return!0
var a=e.hash,o=e.protocol,i=e.hostname,s=e.port,l=e.pathname
if(Xr.test(a))return!1
...
var v=parseInt(g.getPropertyValue("height")),b=parseInt(g.getPropertyValue("width")),y=jo(t),w=y&&0===v,D=y&&0===b,x="absolute"===g.getPropertyValue("position")&&(v<2||b<2)&&"hidden"===g.getPropertyValue("overflow")
...
0!==h.width&&0!==h.height&&sa(u)&&ga(p,c),Vr(u)&&ua(u.shadowRoot,p,c),u=l.nextNode()}}function ca(e,t){var n,r,o=arguments.length>2&&void 0!==arguments[2]&&arguments[2],i=t.left+t.width/2,s=t.top+t.height/2,l=s/la|0,u=i/la|0
...
return n?ca(n,t.boundingClientRect):[]},ba=function(e){return Ei(e,"*").filter((function(e){var t=e.isFocusable,n=e.actualNode.getAttribute("tabindex")
return(n=n&&!isNaN(parseInt(n,10))?parseInt(n):null)?t&&n>=0:t}))},ya=function(e){return e?e.replace(/\r\n/g,"\n").replace(/\u00A0/g," ").replace(/[\s]{2,}/g," ").trim():""},wa=function(e){tr.get("gridCreated")||(ua(),tr.set("gridCreated",!0))
var t=nr(e),n=t._grid
if(!n)return[]
var r=t.boundingClientRect,o=[]
return Array.from(e.childNodes).forEach((function(e){if(3===e.nodeType&&""!==ya(e.textContent)){var t=a.createRange()
...
return ya(i)},Ca=function(e){var t
return e.attr("aria-labelledby")&&(t=Ea(e.actualNode,"aria-labelledby").map((function(e){var t=nr(e)
return t?Aa(t):""})).join(" ").trim())||(t=e.attr("aria-label"))&&(t=ya(t))?t:null},ka=["HEAD","TITLE","TEMPLATE","SCRIPT","STYLE","IFRAME","OBJECT","VIDEO","AUDIO","NOSCRIPT"],Fa=function e(t,n,r){return function(e){if(!ka.includes(e.actualNode.nodeName.toUpperCase()))return e.children.some((function(e){var t=e.actualNode
return 3===t.nodeType&&t.nodeValue.trim()}))}(t)||xa(t.actualNode)||!r&&!!Ca(t)||!n&&t.children.some((function(t){return 1===t.actualNode.nodeType&&e(t)}))},Ta=function(e,t,n){return e=nr(e),Fa(e,t,n)}
function Na(e,t){var n=nr(e)
...
var i=Kr(e)
return!(!i||a.includes(o))&&Na(i,o)}var _a=Na,Oa=function(e){var t=e instanceof _t?e:nr(e)
...
break}"fieldset"===n.props.nodeName&&n.hasAttr("disabled")&&(a=!0),n=n.parent}return r.forEach((function(e){return e._inDisabledFieldset=a})),!!a||"area"!==t.props.nodeName&&!!t.actualNode&&_a(t.actualNode)},Sa=function(e){var t=e instanceof _t?e:nr(e)
if(!t||Oa(t))return!1
...
return!(!n||isNaN(parseInt(n,10)))},Pa=function(e){return parseInt(e.getAttribute("tabindex"),10)>-1&&Ia(e)&&!Sa(e)},ja=function(e){var t=e.doctype
...
if("A"===o&&t.href||"link"===(t.getAttribute("role")||"").toLowerCase())return t===e&&(a=1),r+=t.textContent,!1}}})),n=ya(n),r=ya(r),n.length>r.length},Ua=function(e){var t=(e=e||{}).modalPercent||.75
...
if("object"===o(h))return h.v}tr.set("isModalOpen",void 0)},Ha=function(e){return e instanceof n.Node},Va={},za={set:function(e,t){if("string"!=typeof e)throw new Error("Incomplete data: key must be a string")
return t&&(Va[e]=t),Va[e]},get:function(e){return Va[e]},clear:function(){Va={}}},$a=function(e,t){var r=e.nodeName.toUpperCase()
...
return.2126*(e<=.03928?e/12.92:Math.pow((e+.055)/1.055,2.4))+.7152*(t<=.03928?t/12.92:Math.pow((t+.055)/1.055,2.4))+.0722*(n<=.03928?n/12.92:Math.pow((n+.055)/1.055,2.4))}},Xa=function(e){var t=new Ja
...
return Array.from(r.elementsFromPoint(t,n)||[]).filter((function(e){return Wr(e)===r})).reduce((function(r,a){if(Vr(a)){var i=e(t,n,a.shadowRoot,o+1);(r=r.concat(i)).length&&no(r[0],a)&&r.push(a)}else r.push(a)
return r}),[])}
function io(e){var t={}
...
i=o._isXHTML?i:(i||"").toLowerCase(),Si().includes(i)||(i="text"),o._type=i}return tr.get("nodeMap")&&tr.get("nodeMap").set(e,T(o)),o}return j(r,[{key:"props",get:function(){if(!this._cache.hasOwnProperty("props")){var e=this.actualNode,t=e.nodeType,n=e.nodeName,r=e.id,a=e.multiple,o=e.nodeValue,i=e.value,s=e.selected
...
return this._cache.hasOwnProperty(t)||(this._cache.hasOwnProperty("computedStyle")||(this._cache.computedStyle=n.getComputedStyle(this.actualNode)),this._cache[t]=this._cache.computedStyle.getPropertyValue(e)),this._cache[t]}},{key:"isFocusable",get:function(){return this._cache.hasOwnProperty("isFocusable")||(this._cache.isFocusable=Ia(this.actualNode)),this._cache.isFocusable}},{key:"tabbableElements",get:function(){return this._cache.hasOwnProperty("tabbableElements")||(this._cache.tabbableElements=ba(this)),this._cache.tabbableElements}},{key:"clientRects",get:function(){return this._cache.hasOwnProperty("clientRects")||(this._cache.clientRects=Array.from(this.actualNode.getClientRects()).filter((function(e){return e.width>0}))),this._cache.clientRects}},{key:"boundingClientRect",get:function(){return this._cache.hasOwnProperty("boundingClientRect")||(this._cache.boundingClientRect=this.actualNode.getBoundingClientRect()),this._cache.boundingClientRect}}]),r}(_t)
function ho(e,t,r){var a,o,i
function s(e,n,r){var a=ho(n,t,r)
return a&&(e=e.concat(a)),e}return e.documentElement&&(e=e.documentElement),i=e.nodeName.toLowerCase(),Vr(e)?(a=new fo(e,r,t),t="a"+Math.random().toString().substring(2),o=Array.from(e.shadowRoot.childNodes),a.children=o.reduce((function(e,t){return s(e,t,a)}),[]),[a]):"content"===i&&"function"==typeof e.getDistributedNodes?(o=Array.from(e.getDistributedNodes())).reduce((function(e,t){return s(e,t,r)}),[]):"slot"===i&&"function"==typeof e.assignedNodes?((o=Array.from(e.assignedNodes())).length||(o=function(e){var t=[]
...
return"function"==typeof e&&(e=e()),"string"!=typeof e?"":e}var yo=Tt.resultGroups,wo=function(e,t){var n=i.utils.aggregateResult(e)
return yo.forEach((function(e){t.resultTypes&&!t.resultTypes.includes(e)&&(n[e]||[]).forEach((function(e){Array.isArray(e.nodes)&&e.nodes.length>0&&(e.nodes=[e.nodes[0]])})),n[e]=(n[e]||[]).map((function(e){return e=Object.assign({},e),Array.isArray(e.nodes)&&e.nodes.length>0&&(e.nodes=e.nodes.map((function(e){return"object"===o(e.node)&&(e.html=e.node.source,t.elementRef&&!e.node.fromFrame&&(e.element=e.node.element),(!1!==t.selectors||e.node.fromFrame)&&(e.target=e.node.selector),t.ancestry&&(e.ancestry=e.node.ancestry),t.xpath&&(e.xpath=e.node.xpath)),delete e.result,delete e.node,function(e,t){["any","all","none"].forEach((function(n){Array.isArray(e[n])&&e[n].filter((function(e){return Array.isArray(e.relatedNodes)})).forEach((function(e){e.relatedNodes=e.relatedNodes.map((function(e){var n={html:e.source}
return t.elementRef&&!e.fromFrame&&(n.element=e.element),(!1!==t.selectors||e.fromFrame)&&(n.target=e.selector),t.ancestry&&(n.ancestry=e.ancestry),t.xpath&&(n.xpath=e.xpath),n}))}))}))}(e,t),e}))),yo.forEach((function(t){return delete e[t]})),delete e.pageLevel,delete e.result,e}))})),n}
i._thisWillBeDeletedDoNotUse=i._thisWillBeDeletedDoNotUse||{},i._thisWillBeDeletedDoNotUse.helpers={failureSummary:vo,incompleteFallbackMessage:bo,processAggregate:wo}
var Do=/\$\{\s?data\s?\}/g
...
return t&&"object"===o(t)?t:"object"!==o(r)?{}:{testEngine:{name:"axe-core",version:i.version},testRunner:{name:i._audit.brand},testEnvironment:Fo(r),timestamp:(new Date).toISOString(),url:null===(e=r.location)||void 0===e?void 0:e.href}}function Fo(e){if(!e.navigator||"object"!==o(e.navigator))return{}
...
return{userAgent:n.userAgent,windowWidth:a,windowHeight:r,orientationAngle:s,orientationType:l}}function To(e,t){var n=t.focusable,r=t.page
return{node:e,include:[],exclude:[],initiator:!1,focusable:n&&No(e),size:Ro(e),page:r}}function No(e){var t=e.getAttribute("tabindex")
if(!t)return!0
var n=parseInt(t,10)
...
Array.from(o).forEach((function(r){if(e.frames.forEach((function(e){e.node===r&&e[t].push(n)})),!e.frames.find((function(e){return e.node===r}))){var a=To(r,e)
...
break}!r||!r.length||r instanceof n.Node?r instanceof n.Node&&(r.documentElement instanceof n.Node?i.push(e.flatTree[0]):i.push(nr(r))):r.length>1?_o(e,t,r):(o=Array.from(a.querySelectorAll(r[0])),i=i.concat(o.map((function(e){return nr(e)}))))}return i.filter((function(e){return e}))}function So(e,t){var r,i,s,l,u,c=this
...
if(s instanceof n.Document)return s.documentElement}return a.documentElement}(e)),this.exclude=e.exclude,this.include=e.include,this.include=Oo(this,"include"),this.exclude=Oo(this,"exclude"),Ti("frame, iframe",this).forEach((function(e){Go(e,c)&&function(e,t){zo(t)||Pr(e.frames,"node",t)||e.frames.push(To(t,e))}(c,e.actualNode)})),void 0===this.page&&(this.page=1===(u=this.include).length&&u[0].actualNode===a.documentElement,this.frames.forEach((function(e){e.page=c.page})))
var d=function(e){if(0===e.include.length){if(0===e.frames.length){var t=Nr.isInFrame()?"frame":"page"
...
Array.isArray(this.include)||(this.include=Array.from(this.include)),this.include.sort(Jo)}function Io(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{}
if(!1===t.iframes)return[]
var n=new So(e),r=n.frames
return r.map((function(e){var t=e.node,n=R(e,u)
return n.initiator=!1,{frameSelector:Jn(t),frameContext:n}}))}var Po=function(e){var t=i._audit.rules.find((function(t){return t.id===e}))
...
if(r||a){var o=n.getComputedStyle(e),i=Mo(o,"overflow-x"),s=Mo(o,"overflow-y")
return r&&i||a&&s?{elm:e,top:e.scrollTop,left:e.scrollLeft}:void 0}}function Mo(e,t){var n=e.getPropertyValue(t)
return["scroll","auto"].includes(n)}function qo(e){return Array.from(e.children||e.childNodes||[]).reduce((function(e,t){var n=jo(t)
return n&&e.push(n),e.concat(qo(t))}),[])}var Lo=function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:n,t=e.document.documentElement,r=[void 0!==e.pageXOffset?{elm:e,top:e.pageYOffset,left:e.pageXOffset}:{elm:t,top:t.scrollTop,left:t.scrollLeft}]
return r.concat(qo(a.body))}
function Bo(){return sr(Ka)}var Uo,Ho=function(e){if(!e)throw new Error("axe.utils.getStyleSheetFactory should be invoked with an argument")
...
return e.head.appendChild(c),{sheet:c.sheet,isCrossOrigin:a,shadowId:o,root:i,priority:s}}},Vo=function(e){if(Uo&&Uo.parentNode)return void 0===Uo.styleSheet?Uo.appendChild(a.createTextNode(e)):Uo.styleSheet.cssText+=e,Uo
if(e){var t=a.head||a.getElementsByTagName("head")[0]
return(Uo=a.createElement("style")).type="text/css",void 0===Uo.styleSheet?Uo.appendChild(a.createTextNode(e)):Uo.styleSheet.cssText=e,t.appendChild(Uo),Uo}},zo=function e(t,r){var a=nr(t)
...
return a&&(a._isHidden=i),i},$o=function(e){var t,n,r=null!==(t=null===(n=e.props)||void 0===n?void 0:n.nodeName)&&void 0!==t?t:e.nodeName.toLowerCase()
...
return Array.isArray(e)?e.length===r.length&&e.every((function(e,t){return r[t]===e})):e===r}))},Qo=U(Dt())
i._memoizedFns=[]
var Ko=function(e){var t=Qo.default(e)
return i._memoizedFns.push(t),t},Jo=function(e,t){return(e=e.actualNode||e)===(t=t.actualNode||t)?0:4&e.compareDocumentPosition(t)?-1:1},Xo=function(e,t,n,r){var a=arguments.length>4&&void 0!==arguments[4]&&arguments[4],o=Array.from(e.cssRules)
...
return o?Xo(e,t,n,r,a):oi(e.href,t,n,r,!0)},oi=function(e,t,n,r,a){return r.push(e),new Promise((function(t,n){var r=new XMLHttpRequest
...
n.push(c)})),Promise.all(n)}(n,Ho(r)).then((function(e){return hi(e)}))}
...
var t}function yi(e){var t=Tt.preload,n=t.assets,r=t.timeout,a={assets:n,timeout:r}
...
return bi(e)?new Promise((function(n,r){var a=yi(e),o=a.assets,i=a.timeout,s=setTimeout((function(){return r(new Error("Preload assets timed out."))}),i)
...
return r}catch(r){return"string"==typeof e.missingData?t.incomplete[e.missingData]:n(t)}}(r.data,i)),s.message||(s.message=i.incomplete)),"function"!=typeof s.message&&(s.message=Eo(s.message,r.data)),Ur(r,s)}}var xi=function(e){var t=i._audit.data.checks||{},n=i._audit.data.rules||{},r=Pr(i._audit.rules,"id",e.id)||{}
e.tags=sr(r.tags||[])
var a=Di(t,!0,r),o=Di(t,!1,r)
e.nodes.forEach((function(e){e.any.forEach(a),e.all.forEach(a),e.none.forEach(o)})),Ur(e,sr(n[e.id]||{}))},Ei=function(e,t){return pi(e,t)}
...
return tr.get(o)?r=tr.get(o):i&&(r=a.createElement(r.nodeName),Array.from(i).forEach((function(e){(function(e,t,n){return void 0!==n[t]&&(!0===n[t]||Sn(e,n[t]))})(t,e.name,n)||r.setAttribute(e.name,e.value)})),tr.set(o,r)),Array.from(t.childNodes).forEach((function(t){r.appendChild(e(t,n))})),r}
function Fi(e,t){var n
if(0===e.length)return t
e.length<t.length&&(n=e,e=t,t=n)
for(var r=0,a=t.length;r<a;r++)e.includes(t[r])||e.push(t[r])
return e}var Ti=function(e,t){var n,r=[]
if(i._selectCache)for(var a=0,o=i._selectCache.length;a<o;a++){var s=i._selectCache[a]
if(s.selector===e)return s.result}for(var l=t.include.reduce((function(e,t){return e.length&&Lr(e[e.length-1],t)||e.push(t),e}),[]),u=function(e){return e.exclude&&0!==e.exclude.length?function(t){return Go(t,e)}:null}(t),c=0;c<l.length;c++)n=l[c],r=Fi(r,pi(n,e,u))
return i._selectCache&&i._selectCache.push({selector:e,result:r}),r},Ni=function(e){e.forEach((function(e){return function(e,t,r){if(e===n)return e.scroll(r,t)
...
var Mi=function(e){A(n,e)
var t=k(n)
function n(e){var r,a,i,s
return I(this,n),(r=t.call(this))._props=function(e){var t,n,r,a=null!==(t=e.nodeName)&&void 0!==t?t:Li[e.nodeType],o=null!==(n=null!==(r=e.nodeType)&&void 0!==r?r:qi[e.nodeName])&&void 0!==n?n:1
Pt("number"==typeof o,"nodeType has to be a number, got '".concat(o,"'")),Pt("string"==typeof a,"nodeName has to be a string, got '".concat(a,"'"))
var i=null
"input"===(a=a.toLowerCase())&&(i=(e.type||e.attributes&&e.attributes.type||"").toLowerCase(),Si().includes(i)||(i="text"))
...
return null!==(t=this._attrs[e])&&void 0!==t?t:null}},{key:"hasAttr",value:function(e){return void 0!==this._attrs[e]}},{key:"attrNames",get:function(){return Object.keys(this._attrs)}}]),n}(_t),qi={"#cdata-section":2,"#text":3,"#comment":8,"#document":9,"#document-fragment":11},Li={}
Object.keys(qi).forEach((function(e){Li[qi[e]]=e}))
var Bi=Mi,Ui={}
B(Ui,{allowedAttr:function(){return Vi},arialabelText:function(){return zi},arialabelledbyText:function(){return ul},getAccessibleRefs:function(){return El},getElementUnallowedRoles:function(){return Rl},getExplicitRole:function(){return Gi},getImplicitRole:function(){return bs},getOwnedVirtual:function(){return Ts},getRole:function(){return As},getRoleType:function(){return Al},getRolesByType:function(){return Ol},getRolesWithNameFromContents:function(){return Il},implicitNodes:function(){return Ll},implicitRole:function(){return bs},isAccessibleRef:function(){return Bl},isAriaRoleAllowedOnElement:function(){return Cl},isUnsupportedRole:function(){return $i},isValidRole:function(){return Wi},label:function(){return Ul},labelVirtual:function(){return Ca},lookupTable:function(){return ql},namedFromContents:function(){return Fs},requiredAttr:function(){return Hl},requiredContext:function(){return Vl},requiredOwned:function(){return zl},validateAttr:function(){return Wl},validateAttrValue:function(){return $l}})
var Hi=function(){if(tr.get("globalAriaAttrs"))return tr.get("globalAriaAttrs")
var e=Object.keys(Ka.ariaAttrs).filter((function(e){return Ka.ariaAttrs[e].global}))
return tr.set("globalAriaAttrs",e),e},Vi=function(e){var t=Ka.ariaRoles[e],n=_(Hi())
return t?(t.allowedAttrs&&n.push.apply(n,_(t.allowedAttrs)),t.requiredAttrs&&n.push.apply(n,_(t.requiredAttrs)),n):n},zi=function(e){if(!(e instanceof _t)){if(1!==e.nodeType)return""
e=nr(e)}return e.attr("aria-label")||""},$i=function(e){var t=Ka.ariaRoles[e]
return!!t&&!!t.unsupported},Wi=function(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},n=t.allowAbstract,r=t.flagUnsupported,a=void 0!==r&&r,o=Ka.ariaRoles[e],i=$i(e)
...
for(t||(t=Qi(Qr(e,"table"))),n=0;n<t.length;n++)if(t[n]&&-1!==(r=t[n].indexOf(e)))return{x:r,y:n}})),Ji=function(e){var t=e.getAttribute("scope"),r=e.getAttribute("role")
...
return a[o.y].reduce((function(e,t){return e&&"TH"===t.nodeName.toUpperCase()}),!0)?"col":a.map((function(e){return e[o.x]})).reduce((function(e,t){return e&&t&&"TH"===t.nodeName.toUpperCase()}),!0)?"row":"auto"},Xi=function(e){return-1!==["col","auto"].indexOf(Ji(e))},Zi=function(e){return["row","auto"].includes(Ji(e))},es=Yi("sectioning").map((function(e){return"".concat(e,":not([role])")})).join(", ")+" , main:not([role]), [role=article], [role=complementary], [role=main], [role=navigation], [role=region]"
function ts(e){var t=ya(ul(e)),n=ya(zi(e))
return!(!t&&!n)}var ns={a:function(e){return e.hasAttr("href")?"link":null},area:function(e){return e.hasAttr("href")?"link":null},article:"article",aside:"complementary",body:"document",button:"button",datalist:"listbox",dd:"definition",dfn:"term",details:"group",dialog:"dialog",dt:"term",fieldset:"group",figure:"figure",footer:function(e){return xr(e,es)?null:"contentinfo"},form:function(e){return ts(e)?"form":null},h1:"heading",h2:"heading",h3:"heading",h4:"heading",h5:"heading",h6:"heading",header:function(e){return xr(e,es)?null:"banner"},hr:"separator",img:function(e){var t=e.hasAttr("alt")&&!e.attr("alt"),n=Hi().find((function(t){return e.hasAttr(t)}))
...
return["grid","treegrid"].includes(n)?"gridcell":"cell"},textarea:"textbox",tfoot:"rowgroup",th:function(e){return Xi(e.actualNode)?"columnheader":Zi(e.actualNode)?"rowheader":void 0},thead:"rowgroup",tr:"row",ul:"list"},rs=function(e,t){var n=o(t)
...
return s||null}return"function"==typeof o?o(r):o||null},ys={td:["tr"],th:["tr"],tr:["thead","tbody","tfoot","table"],thead:["table"],tbody:["table"],tfoot:["table"],li:["ol","ul"],dt:["dl","div"],dd:["dl","div"],div:["dl"]}
function ws(e,t){var n=ys[e.props.nodeName]
if(!n)return null
...
var r=Gi(e.parent,t)
return["none","presentation"].includes(r)&&!xs(e.parent)?r:r?null:ws(e.parent,t)}function Ds(e,t){var n=t.chromium,r=R(t,p),a=bs(e,{chromium:n})
return a?ws(e,r)||a:null}function xs(e){return Hi().some((function(t){return e.hasAttr(t)}))||Ia(e)}function Es(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},n=t.noImplicit,r=R(t,f),a=e instanceof _t?e:nr(e)
...
return 1===t.props.nodeType&&e.hasAttr("title")?!ms(t,Cs)&&["none","presentation"].includes(As(t))?"":t.attr("title"):""},Fs=function(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},n=t.strict
if(1!==(e=e instanceof _t?e:nr(e)).props.nodeType)return!1
var r=As(e),a=Ka.ariaRoles[r]
return!(!a||!a.nameFromContent)||!n&&(!a||["presentation","none"].includes(r))},Ts=function(e){var t=e.actualNode,n=e.children
...
return[].concat(_(n),_(r))}return _(n)},Ns=Yi("phrasing").concat(["#text"])
function Rs(e,t,n){var r=t.props.nodeName,a=sl(t,n)
return a?(Ns.includes(r)||(" "!==a[0]&&(a+=" "),e&&" "!==e[e.length-1]&&(a=" "+a)),e+a):e}var _s=function(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},n=sl.alreadyProcessed
...
if(!Fs(e,{strict:a})&&!t.subtreeDescendant)return""
if(!a){var u=!o&&!i
t=S({subtreeDescendant:u},t)}return Ts(e).reduce((function(e,n){return Rs(e,n,t)}),"")}
...
return Gr({elm:"label",attr:"for",value:e.attr("id"),context:e.actualNode})}var Ss=function(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},n=sl.alreadyProcessed
if(t.inControlContext||t.inLabelledByContext||n(e,t))return""
t.startNode||(t.startNode=e)
var r,a=S({inControlContext:!0},t),o=Os(e),i=xr(e,"label")
return i?(r=[].concat(_(o),[i.actualNode])).sort(Jo):r=o,r.map((function(e){return ll(e,a)})).filter((function(e){return""!==e})).join(" ")},Is={submit:"Submit",image:"Submit",reset:"Reset",button:""}
...
return o&&o.nodeName.toLowerCase()===e?ll(o,n):""}var Ms={valueText:function(e){return e.actualNode.value||""},buttonDefaultText:function(e){var t=e.actualNode
return Is[t.type]||""},tableCaptionText:js.bind(null,"caption"),figureText:js.bind(null,"figcaption"),svgTitleText:js.bind(null,"title"),fieldsetLegendText:js.bind(null,"legend"),altText:Ps.bind(null,"alt"),tableSummaryText:Ps.bind(null,"summary"),titleText:ks,subtreeText:_s,labelText:Ss,singleSpace:function(){return" "},placeholderText:Ps.bind(null,"placeholder")}
function qs(e){return(vs(e,{noMatchAccessibleName:!0}).namingMethods||[]).map((function(e){return Ms[e]}))}var Ls=function(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},n=e.actualNode
if(1!==e.props.nodeType||["presentation","none"].includes(As(e)))return""
var r=qs(e),a=r.reduce((function(n,r){return n||r(e,t)}),"")
return t.debug&&i.log(a||"{empty-value}",n,t),a},Bs={accessibleNameFromFieldValue:["combobox","listbox","progressbar"]},Us=["button","checkbox","color","file","hidden","image","password","radio","reset","submit"],Hs=function(e){var t=(e=e instanceof _t?e:nr(e)).props.nodeName
return"textarea"===t||"input"===t&&!Us.includes((e.attr("type")||"").toLowerCase())},Vs=function(e){return"select"===(e=e instanceof _t?e:nr(e)).props.nodeName},zs=function(e){return"textbox"===Gi(e)},$s=function(e){return"listbox"===Gi(e)},Ws=function(e){return"combobox"===Gi(e)},Gs=["progressbar","scrollbar","slider","spinbutton"],Ys=function(e){var t=Gi(e)
...
return Hs(t)&&t.props.value||""},nativeSelectValue:function(e){var t=e instanceof _t?e:nr(e)
if(!Vs(t))return""
...
return zs(t)?!n||n&&!_a(n)?Aa(t,!0):n.textContent:""},ariaListboxValue:Js,ariaComboboxValue:function(e,t){var n=e instanceof _t?e:nr(e)
if(!Ws(n))return""
var r=Ts(n).filter((function(e){return"listbox"===As(e)}))[0]
...
if(!$s(n))return""
var r=Ts(n).filter((function(e){return"option"===As(e)&&"true"===e.attr("aria-selected")}))
return 0===r.length?"":sl(r[0],t)}var Xs=function(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},n=e.actualNode,r=Bs.accessibleNameFromFieldValue||[],a=As(e)
...
return t.debug&&Nt(i||"{empty-value}",n,t),i},Zs=U(xt()),el=function(e,t){var n=t.emoji,r=t.nonBmp,a=t.punctuations
...
if(!ya(o)||el(o,{emoji:!0,nonBmp:!0}))return!1
...
if(ol(e,t))return""
var r=[ul,zi,Ls,Xs,_s,rl,ks],a=r.reduce((function(n,r){return t.startNode===e&&(n=ya(n)),""!==n?n:r(e,t)}),"")
...
return t.startNode||(t=S({startNode:e},t)),n?(1===n.nodeType&&t.inLabelledByContext&&void 0===t.includeHidden&&(t=S({includeHidden:!sa(n,!0)},t)),t):t}nl.alreadyProcessed=function(e,t){return t.processed=t.processed||[],!!t.processed.includes(e)||(t.processed.push(e),!1)}
...
return n.reduce((function(n,r){var a=ll(r,S({inLabelledByContext:!0,startNode:t.startNode||e},t))
return n?"".concat(n," ").concat(a):a}),"")},cl={}
B(cl,{accessibleText:function(){return ll},accessibleTextVirtual:function(){return sl},autocomplete:function(){return hl},formControlValue:function(){return Xs},formControlValueMethods:function(){return Ks},hasUnicode:function(){return el},isHumanInterpretable:function(){return fl},isIconLigature:function(){return tl},isValidAutocomplete:function(){return ml},label:function(){return bl},labelText:function(){return Ss},labelVirtual:function(){return vl},nativeElementType:function(){return yl},nativeTextAlternative:function(){return Ls},nativeTextMethods:function(){return Ms},removeUnicode:function(){return pl},sanitize:function(){return ya},subtreeText:function(){return _s},titleText:function(){return ks},unsupported:function(){return Bs},visible:function(){return gl},visibleTextNodes:function(){return wl},visibleVirtual:function(){return Aa}})
var dl=U(xt()),pl=function(e,t){var n=t.emoji,r=t.nonBmp,a=t.punctuations
...
return ya(t)?1:0},hl={stateTerms:["on","off"],standaloneTerms:["name","honorific-prefix","given-name","additional-name","family-name","honorific-suffix","nickname","username","new-password","current-password","organization-title","organization","street-address","address-line1","address-line2","address-line3","address-level4","address-level3","address-level2","address-level1","country","country-name","postal-code","cc-name","cc-given-name","cc-additional-name","cc-family-name","cc-number","cc-exp","cc-exp-month","cc-exp-year","cc-csc","cc-type","transaction-currency","transaction-amount","language","bday","bday-day","bday-month","bday-year","sex","url","photo","one-time-code"],qualifiers:["home","work","mobile","fax","pager"],qualifiedTerms:["tel","tel-country-code","tel-national","tel-area-code","tel-local","tel-local-prefix","tel-local-suffix","tel-extension","email","impp"],locations:["billing","shipping"]},ml=function(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},n=t.looseTyped,r=void 0!==n&&n,a=t.stateTerms,o=void 0===a?[]:a,i=t.locations,s=void 0===i?[]:i,l=t.qualifiers,u=void 0===l?[]:l,c=t.standaloneTerms,d=void 0===c?[]:c,p=t.qualifiedTerms,f=void 0===p?[]:p
...
t[r]=t[r]||[],t[r].push(e)}for(var a=0;a<n.length;++a){var o=n[a],i=ya(e.getAttribute(o)||"")
...
return!(!t.parentNode||"http://www.w3.org/2000/svg"!==t.parentNode.namespaceURI)||n}},Ml.rolesOfType={widget:["button","checkbox","dialog","gridcell","link","log","marquee","menuitem","menuitemcheckbox","menuitemradio","option","progressbar","radio","scrollbar","searchbox","slider","spinbutton","status","switch","tab","tabpanel","textbox","timer","tooltip","tree","treeitem"]}
var ql=Ml,Ll=function(e){var t=null,n=ql.role[e]
return n&&n.implicit&&(t=sr(n.implicit)),t},Bl=function(e){return!!El(e).length},Ul=function(e){return e=nr(e),Ca(e)},Hl=function(e){var t=Ka.ariaRoles[e]
return t&&Array.isArray(t.requiredAttrs)?_(t.requiredAttrs):[]},Vl=function(e){var t=Ka.ariaRoles[e]
return t&&Array.isArray(t.requiredContext)?_(t.requiredContext):null},zl=function(e){var t=Ka.ariaRoles[e]
return t&&Array.isArray(t.requiredOwned)?_(t.requiredOwned):null},$l=function(e,t){var n,r,a=(e=e instanceof _t?e:nr(e)).attr(t),o=Ka.ariaAttrs[t]
if(!o)return!0
...
o=o.parent}}return n}B(Yl,{getAriaRolesByType:function(){return _l},getAriaRolesSupportingNameFromContent:function(){return Sl},getElementSpec:function(){return vs},getElementsByContentType:function(){return Yi},getGlobalAriaAttrs:function(){return Hi},implicitHtmlRoles:function(){return ns}})
var Kl={ARTICLE:!0,ASIDE:!0,NAV:!0,SECTION:!0},Jl={application:!0,banner:!1,complementary:!0,contentinfo:!0,form:!0,main:!0,navigation:!0,region:!0,search:!1},Xl={}
B(Xl,{getAllCells:function(){return Zl},getCellPosition:function(){return Ki},getHeaders:function(){return tu},getScope:function(){return Ji},isColumnHeader:function(){return Xi},isDataCell:function(){return nu},isDataTable:function(){return ru},isHeader:function(){return au},isRowHeader:function(){return Zi},toArray:function(){return Qi},toGrid:function(){return Qi},traverse:function(){return iu}})
...
return o}
function eu(e,t,n){for(var r,a="row"===e?"_rowHeaders":"_colHeaders",o="row"===e?Zi:Xi,s=n[t.y][t.x],l=s.colSpan-1,u=s.getAttribute("rowspan"),c=(0===parseInt(u)||0===s.rowspan?n.length:s.rowSpan)-1,d=t.y+c,p=t.x+l,f="row"===e?t.y:0,h="row"===e?0:t.x,m=[],g=d;g>=f&&!r;g--)for(var v=p;v>=h;v--){var b=n[g]?n[g][v]:void 0
if(b){var y=i.utils.getNodeFromTree(b)
if(y[a]){r=y[a]
break}m.push(b)}}return r=(r||[]).concat(m.filter(o)),m.forEach((function(e){i.utils.getNodeFromTree(e)[a]=r})),r}var tu=function(e,t){if(e.getAttribute("headers")){var n=Ea(e,"headers")
...
h=n.getComputedStyle(o).getPropertyValue("background-image")}return l>=20||!(na(e).width>.95*ra(n).width)&&!(s<10)&&!e.querySelector("object, embed, iframe, applet")},au=function(e){if(Xi(e)||Zi(e))return!0
...
B(su,{Color:function(){return Ja},centerPointOfRect:function(){return lu},elementHasImage:function(){return $a},elementIsDistinct:function(){return cu},filteredRectStack:function(){return pu},flattenColors:function(){return gu},flattenShadowColors:function(){return vu},getBackgroundColor:function(){return Eu},getBackgroundStack:function(){return yu},getContrast:function(){return Fu},getForegroundColor:function(){return Nu},getOwnBackgroundColor:function(){return Xa},getRectStack:function(){return du},getTextShadowColors:function(){return xu},hasValidContrastRatio:function(){return Ru},incompleteData:function(){return za}})
...
if(["border-bottom","border-top","outline"].reduce((function(e,t){var n=new Ja
...
return new Ja(s,l,u,i)},vu=function(e,t){var n=e.alpha,r=(1-n)*t.red+n*e.red,a=(1-n)*t.green+n*e.green,o=(1-n)*t.blue+n*e.blue,i=e.alpha+t.alpha*(1-e.alpha)
return new Ja(r,a,o,i)}
function bu(e,t){var r=Node.DOCUMENT_POSITION_CONTAINED_BY
if(!(e.compareDocumentPosition(t)&r))return!1
var a=n.getComputedStyle(t)
return!!a.getPropertyValue("display").includes("inline")&&"static"===a.getPropertyValue("position")}var yu=function(e){var t=pu(e)
if(null===t)return null
var r=(t=function(e){var t=e.indexOf(a.body),r=e,o=Xa(n.getComputedStyle(a.documentElement))
if(t>1&&0===o.alpha&&!$a(a.documentElement)){t>1&&(r.splice(t,1),r.push(a.body))
var i=r.indexOf(a.documentElement)
i>0&&(r.splice(i,1),r.push(a.documentElement))}return r}(t=to(t,e))).indexOf(e)
return function(e,t,n){for(var r=e-1;r>=0;r--){if(!bu(n,t[r]))return!0
...
if(n>a||r>a)return new Ja(0,0,0,0)
var i=new Ja
...
var s=yu(e)
if((s||[]).some((function(t){var a=n.getComputedStyle(t),o=Xa(a)
if(Au(e,t,o)||$a(t,a))return i=null,r.push(t),!0
...
if((t=i).unshift.apply(t,_(l)),0===i.length)return new Ja(255,255,255,1)
var u=i.reduce((function(e,t){return gu(t.color,e.color instanceof Ja?e.color:e,t.blendMode)}))
return gu(u.color instanceof Ja?u.color:u,new Ja(255,255,255,1))}function Au(e,t,n){var r=e!==t&&!no(e,t)&&0!==n.alpha
return r&&za.set("bgColor","elmPartiallyObscured"),r}function Cu(e){return e||void 0}function ku(e,t){var r=[]
if(!t){var o=a.documentElement,i=a.body,s=n.getComputedStyle(o),l=n.getComputedStyle(i),u=Xa(s),c=Xa(l),d=0!==c.alpha&&no(e,i);(0!==c.alpha&&0===u.alpha||d&&1!==c.alpha)&&r.unshift({color:c,blendMode:Cu(l.getPropertyValue("mix-blend-mode"))}),0!==u.alpha&&(!d||d&&1!==c.alpha)&&r.unshift({color:u,blendMode:Cu(s.getPropertyValue("mix-blend-mode"))})}return r}var Fu=function(e,t){if(!t||!e)return null
t.alpha<1&&(t=gu(t,e))
var n=e.getRelativeLuminance(),r=t.getRelativeLuminance()
return(Math.max(r,n)+.05)/(Math.min(r,n)+.05)}
function Tu(e){if(!e)return 1
var t=nr(e)
if(t&&void 0!==t._opacity&&null!==t._opacity)return t._opacity
var r=n.getComputedStyle(e).getPropertyValue("opacity")*Tu(e.parentElement)
return t&&(t._opacity=r),r}var Nu=function(e,t,r){var a=n.getComputedStyle(e),o=new Ja
o.parseString(a.getPropertyValue("color"))
var i=Tu(e)
if(o.alpha=o.alpha*i,1===o.alpha)return o
if(r||(r=Eu(e,[])),null===r){var s=za.get("bgColor")
return za.set("fgColor",s),null}if(o.alpha<1){var l=xu(e,{minRatio:0})
return[o].concat(_(l),[r]).reduce(vu)}return gu(o,r)},Ru=function(e,t,n,r){var a=Fu(e,t),o=r&&Math.ceil(72*n)/96<14||!r&&Math.ceil(72*n)/96<18?4.5:3
...
if(0===Xa(r).alpha&&a("background-image","none"))return 0
...
return{value:parseFloat(r),unit:o.toLowerCase()}}function Su(e,t){var n=e.getRelativeLuminance(),r=t.getRelativeLuminance()
...
return-1!==Iu.indexOf(t)||"table-"===t.substr(0,6)}function ju(e,t){var n,r=null===(n=t.data)||void 0===n?void 0:n.headingOrder,a=qu(t.node.ancestry,1)
if(!r)return e
var o=r.map((function(e){return function(e,t){return S({},e,{ancestry:t.concat(e.ancestry)})}(e,a)})),i=function(e,t){for(;t.length;){var n=Mu(e,t)
if(-1!==n)return n
t=qu(t,1)}return-1}(e,a)
return-1===i?e.push.apply(e,_(o)):e.splice.apply(e,[i,0].concat(_(o))),e}function Mu(e,t){return e.findIndex((function(e){return Yo(e.ancestry,t)}))}function qu(e,t){return e.slice(0,e.length-t)}function Lu(e){var t=As(e),n=t&&t.includes("heading"),r=e.attr("aria-level"),a=parseInt(r,10),o=O(e.props.nodeName.match(/h(\d)/)||[],2)[1]
...
return o(r)===o(a)&&("object"==typeof r||"object"==typeof a?Bu(r,a):r===a)}))}var Uu={}
B(Uu,{aria:function(){return Ui},color:function(){return su},dom:function(){return zr},forms:function(){return Hu},matches:function(){return gs},standards:function(){return Yl},table:function(){return Xl},text:function(){return cl},utils:function(){return Ot}})
var Hu={}
B(Hu,{isAriaCombobox:function(){return Ws},isAriaListbox:function(){return $s},isAriaRange:function(){return Ys},isAriaTextbox:function(){return zs},isDisabled:function(){return zu},isNativeSelect:function(){return Vs},isNativeTextbox:function(){return Hs}})
var Vu=["fieldset","button","select","input","textarea"],zu=function e(t){var n=t._isDisabled
if("boolean"==typeof n)return n
var r=t.props.nodeName,a=t.attr("aria-disabled")
return n=!(!Vu.includes(r)||!t.hasAttr("disabled"))||(a?"true"===a.toLowerCase():!!t.parent&&e(t.parent)),t._isDisabled=n,n}
function $u(e){switch(e){case"lighter":return 100
...
return{fontWeight:$u(t.getPropertyValue("font-weight")),fontSize:parseInt(t.getPropertyValue("font-size")),isItalic:"italic"===t.getPropertyValue("font-style")}}function Gu(e,t,n){return n.reduce((function(n,r){return n||(!r.size||e.fontSize/r.size>t.fontSize)&&(!r.weight||e.fontWeight-r.weight>t.fontWeight)&&(!r.italic||e.isItalic&&!t.isItalic)}),!1)}var Yu=_l("landmark"),Qu=["alert","log","status"]
...
return["iframe","frame"].includes(e.props.nodeName)?[e]:[]}return n!==a.body&&Ta(n,!0)?[e]:e.children.filter((function(e){return 1===e.actualNode.nodeType})).map((function(e){return Ku(e,t)})).reduce((function(e,t){return e.concat(t)}),[])}function Ju(e){if(Ia(e))return!0
if(!e.children){if(1===e.props.nodeType)throw new Error("Cannot determine children")
return!1}return e.children.some((function(e){return Ju(e)}))}function Xu(e){if(!e.children){if(1===e.props.nodeType)throw new Error("Cannot determine children")
return[]}var t=[]
return e.children.forEach((function(e){var n=As(e)
"widget"===Al(n)&&Ia(e)?t.push(e):t.push.apply(t,_(Xu(e)))})),t}function Zu(e){var t=parseInt(e.attr("tabindex"),10)
...
return ya(t)}function nc(e){return""!==(e||"").trim()}function rc(e){return!e||"true"!==e.getAttribute("aria-hidden")&&rc(Kr(e))}var ac=function(e,t,n){return n.initiator},oc=function(e,t){try{return"svg"===t.props.nodeName||!!xr(t,"svg")}catch(e){return!1}},ic=function(e,t){var n=vs(t).namingMethods
return!(n&&0!==n.length||"combobox"===Gi(t)&&Ei(t,'input:not([type="hidden"])').length)},sc={"abstractrole-evaluate":function(e,t,n){var r=Oi(n.attr("role")).filter((function(e){return"abstract"===Al(e)}))
return r.length>0&&(this.data(r),!0)},"aria-allowed-attr-evaluate":function(e,t,n){var r=[],a=As(n),o=n.attrNames,i=Vi(a)
...
if(u.forEach((function(e){c[e]=l})),i)for(var d=0;d<o.length;d++){var p,f=o[d];(Wl(f)&&null!==(p=c[f])&&void 0!==p&&p.call(c)||Wl(f)&&!i.includes(f))&&r.push(f+'="'+n.attr(f)+'"')}if(r.length){if(this.data(r),!$o(n)&&!a&&!Ia(n))return
...
return""===ya(u)||void 0},"aria-required-attr-evaluate":function(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},n=arguments.length>2?arguments[2]:void 0,r=[],a=n.attrNames,o=Gi(n)
if(a.length){var i=Hl(o),s=vs(n)
...
return d&&(n.hasAttr("aria-owns")||"true"!==n.attr("aria-expanded"))&&r.splice(r.indexOf("aria-controls",1)),!r.length||(this.data(r),!1)},"aria-required-children-evaluate":function(e,t,n){var r=t&&Array.isArray(t.reviewEmpty)?t.reviewEmpty:[],a=Gi(n,{dpub:!0}),o=zl(a)
if(null===o)return!0
var i=function(e,t){for(var n=[],r=Ts(e),a=function(e){var a=r[e],o=As(a,{noPresentational:!0})
...
return!s||(this.data(s),!(!r.includes(a)||Fa(n,!1,!0)||i.length||n.hasAttr("aria-owns")&&Ea(e,"aria-owns").length)&&void 0)},"aria-required-parent-evaluate":function(e,t,n){var r=t&&Array.isArray(t.ownGroupRoles)?t.ownGroupRoles:[],a=Ql(n,r)
if(!a)return!0
...
try{u=$l(n,e)}catch(t){r="".concat(e,'="').concat(c,'"'),a="idrefs"}l[e]&&!l[e](u)||u||o.push("".concat(e,'="').concat(c,'"'))}})),!r)return!o.length||(this.data(o),!1)
...
return!(r.length<=1)&&(!function(e,t){return!bs(e)&&2===t.length&&t.includes("none")&&t.includes("presentation")}(n,r)||void 0)},"has-global-aria-attribute-evaluate":function(e,t,n){var r=Hi().filter((function(e){return n.hasAttr(e)}))
return this.data(r),r.length>0},"has-implicit-chromium-role-matches":function(e,t){return null!==bs(t,{chromium:!0})},"has-widget-role-evaluate":function(e){var t=e.getAttribute("role")
if(null===t)return!1
var n=Al(t)
...
this.data(o)
try{r=ya(Ss(n)).toLowerCase(),a=ya(sl(n)).toLowerCase()}catch(e){return}return!(!a&&!r)&&!((a||!r)&&a.includes(r))&&void 0},"unsupportedrole-evaluate":function(e,t,n){return $i(As(n))},"valid-scrollable-semantics-evaluate":function(e,t){return function(e,t){var n=Gi(e)
...
return n.forEach((function(e){Ta(e)&&nu(e)&&!Ul(e)&&(tu(e,r).some((function(e){return null!==e&&!!Ta(e)}))||t.push(e))})),!t.length||(this.relatedNodes(t),!1)},"td-headers-attr-evaluate":function(e){for(var t=[],n=[],r=[],a=0;a<e.rows.length;a++)for(var o=e.rows[a],i=0;i<o.cells.length;i++)t.push(o.cells[i])
...
var a=t.filter((function(e){return""!==ya(e.textContent)&&("TH"===e.nodeName.toUpperCase()||-1!==["rowheader","columnheader"].indexOf(e.getAttribute("role")))})),o=Qi(e),i=!0
return a.forEach((function(e){if(!e.getAttribute("id")||!r.includes(e.getAttribute("id"))){var t=Ki(e,o),a=!1
Xi(e)&&(a=iu("down",t,o).find((function(t){return!Xi(t)&&tu(t,o).includes(e)}))),!a&&Zi(e)&&(a=iu("right",t,o).find((function(t){return!Zi(t)&&tu(t,o).includes(e)}))),a||n.relatedNodes(e),i=i&&a}})),!!i||void 0},"hidden-content-evaluate":function(e,t,r){if(!["SCRIPT","HEAD","TITLE","NOSCRIPT","STYLE","TEMPLATE"].includes(e.nodeName.toUpperCase())&&Fa(r)){var a=n.getComputedStyle(e)
...
if(!sa(e,!1))return!0
var f=Aa(r,!1,!0)
if(!a||!function(e){var t={nonBmp:!0},n=el(e,t),r=""===ya(pl(e,t))
...
var m=[],g=Eu(e,m,d),v=Nu(e,!1,g),b=xu(e,{minRatio:.001,maxRatio:d}),y=n.getComputedStyle(e),w=parseFloat(y.getPropertyValue("font-size")),D=y.getPropertyValue("font-weight"),x=parseFloat(D)>=s||"bold"===D,E=null,A=null,C=null
if(0===b.length)E=Fu(g,v)
else if(v&&g){C=[].concat(_(b),[g]).reduce(vu)
var k=Fu(g,v),F=Fu(g,C),T=Fu(C,v);(E=Math.max(k,F,T))!==k&&(A=F>T?"shadowOnBgColor":"fgOnShadowColor")}var N=Math.ceil(72*w)/96,R=x&&N<l||!x&&N<u?c.normal:c.large,O=R.expected,S=R.minThreshold,I=R.maxThreshold,P=E>O
if("number"==typeof S&&E<S||"number"==typeof I&&E>I)return!0
var j,M=Math.floor(100*E)/100
null===g?j=za.get("bgColor"):P||(j=A)
var q=1===M,L=1===f.length
return q?j=za.set("bgColor","equalRatio"):P||!L||o||(j="shortTextContent"),this.data({fgColor:v?v.toHexString():void 0,bgColor:g?g.toHexString():void 0,contrastRatio:M,fontSize:"".concat((72*w/96).toFixed(1),"pt (").concat(w,"px)"),fontWeight:x?"bold":"normal",messageKey:j,expectedContrastRatio:O+":1",shadowColor:C?C.toHexString():void 0}),null===v||null===g||q||L&&!o&&!P?(j=null,za.clear(),void this.relatedNodes(m)):(P||this.relatedNodes(m),P)}this.data({messageKey:"nonBmp"})},"link-in-text-block-evaluate":function(e){if(Pu(e))return!1
for(var t,n,r=Kr(e);1===r.nodeType&&!Pu(r);)r=Kr(r)
if(this.relatedNodes([r]),cu(e,r))return!0
if(t=Nu(e),n=Nu(r),t&&n){var a,o=Su(t,n)
return 1===o||(o>=3?(za.set("fgColor","bgContrast"),this.data({messageKey:za.get("fgColor")}),void za.clear()):(t=Eu(e),n=Eu(r),(!t||!n||Su(t,n)>=3)&&(a=t&&n?"bgContrast":za.get("bgColor"),za.set("fgColor",a),this.data({messageKey:za.get("fgColor")}),void za.clear())))}},"autocomplete-appropriate-evaluate":function(e,t,n){if("input"!==n.props.nodeName)return!0
...
var u=i[l],c=n.hasAttr("type")?ya(n.attr("type")).toLowerCase():"text"
return c=Si().includes(c)?c:"text",void 0===u?"text"===c:u.includes(c)},"autocomplete-valid-evaluate":function(e,t,n){var r=n.attr("autocomplete")||""
...
var r=n.attr(t.attribute),a=!ya(r)
...
return e.forEach((function(e){e.result=function(e,t){var n,r,a,o,i=Mu(t,e.node.ancestry),s=null!==(n=null===(r=t[i])||void 0===r?void 0:r.level)&&void 0!==n?n:-1,l=null!==(a=null===(o=t[i-1])||void 0===o?void 0:o.level)&&void 0!==a?a:-1
...
return e=t.map((function(e){return{ancestry:[Jn(e.actualNode)],level:Lu(e)}})),this.data({headingOrder:e}),tr.set("headingOrder",t),!0},"identical-links-same-purpose-after":function(e){if(e.length<2)return e
...
return e.forEach((function(e){t[e.data]=void 0!==t[e.data]?++t[e.data]:0})),e.forEach((function(e){e.result=!!t[e.data]})),e},"unique-frame-title-evaluate":function(e,t,n){var r=ya(n.attr("title")).toLowerCase()
return this.data(r),!0},"aria-label-evaluate":function(e,t,n){return!!ya(zi(n))},"aria-labelledby-evaluate":function(e,t,n){try{return!!ya(ul(n))}catch(e){return}},"avoid-inline-spacing-evaluate":function(e,t){var n=t.cssProperties.filter((function(t){if("important"===e.style.getPropertyPriority(t))return t}))
return!(n.length>0&&(this.data(n),1))},"doc-has-title-evaluate":function(){var e=a.title
return!!ya(e)},"exists-evaluate":function(){},"has-alt-evaluate":function(e,t,n){var r=n.props.nodeName
...
var o,i=Hi().some((function(e){return n.hasAttr(e)})),s=Ia(n)
...
return this.relatedNodes(o),!(!o.length||!Ua())||0===o.length},"focusable-element-evaluate":function(e,t,n){if(n.hasAttr("contenteditable")&&function e(t){var r=t.attr("contenteditable")
...
return!r||!r.length||!Ua()||void this.relatedNodes(r)},"focusable-no-name-evaluate":function(e,t,n){var r=n.attr("tabindex")
...
var o=a.reduce((function(e,t){var n=t.actualNode,a=n.nodeName.toUpperCase()
return r.includes(a)||e.push(n),e}),[])
return this.relatedNodes(o),!!(o.length>0&&Ua())||0===o.length},"landmark-is-top-level-evaluate":function(e){var t=_l("landmark"),n=Kr(e),r=As(e)
...
n=Kr(n)}return!0},"frame-focusable-content-evaluate":function(e,t,n){if(n.children)try{return!n.children.some((function(e){return Ju(e)}))}catch(e){return}},"no-focusable-content-evaluate":function(e,t,n){if(n.children)try{var r=Xu(n)
...
return!!r&&(a||(a="",e.getAttribute("aria-describedby")&&(a=Ea(e,"aria-describedby").map((function(e){return e?ll(e):""})).join(""))),ya(a)===ya(r))},"hidden-explicit-label-evaluate":function(e,t,n){if(n.hasAttr("id")){if(!n.actualNode)return
...
if(!(fl(i)<1)){var s=ya(_s(n,{subtreeDescendant:!0,ignoreIconLigature:!0,pixelThreshold:a,occuranceThreshold:o})).toLowerCase()
...
if("string"==typeof a){var o=go(a),i=t.value?!t.value.map(go).includes(o):!ji(o);(""!==o&&i||""!==a&&!ya(a))&&r.push(e+'="'+n.attr(e)+'"')}})),!!r.length&&(this.data(r),!0)},"xml-lang-mismatch-evaluate":function(e,t,n){return go(n.attr("lang"))===go(n.attr("xml:lang"))},"dlitem-evaluate":function(e){var t=Kr(e),n=t.nodeName.toUpperCase(),r=Gi(t)
...
return!!zl(n)},"aria-required-parent-matches":function(e,t){var n=Gi(t)
return!!Vl(n)},"autocomplete-matches":function(e,t){var n=t.attr("autocomplete")
if(!n||""===ya(n))return!1
...
if(h&&zu(h))return!1}var m=Ei(p,'input:not([type="hidden"],[type="image"],[type="button"],[type="submit"],[type="reset"]), select, textarea')[0]
if(m&&zu(m))return!1}for(var g=[],v=t;v;){if(v.props.id){var b=El(v).filter((function(e){return Oi(e.getAttribute("aria-labelledby")||"").includes(v.props.id)})).map((function(e){return nr(e)}))
g.push.apply(g,_(b))}v=v.parent}if(g.length>0&&g.every(zu))return!1
var y=Aa(t,!1,!0)
if(!y||!pl(y,{emoji:!0,nonBmp:!1,punctuations:!0}))return!1
for(var w=a.createRange(),D=t.children,x=0;x<D.length;x++){var E=D[x]
3===E.actualNode.nodeType&&""!==ya(E.actualNode.nodeValue)&&w.selectNodeContents(E.actualNode)}for(var A=w.getClientRects(),C=0;C<A.length;C++)if(co(A[C],e))return!0
...
return!!ya(t)},"heading-matches":function(e){var t
...
var n=As(e)
return!n||"link"===n},"inserted-into-focus-order-matches":function(e){return Pa(e)},"is-initiator-matches":ac,"label-content-name-mismatch-matches":function(e,t){var n=As(e)
return!!(n&&_l("widget").includes(n)&&Sl().includes(n)&&(ya(zi(t))||ya(ul(e)))&&ya(Aa(t)))},"label-matches":function(e,t){if("input"!==t.props.nodeName||!1===t.hasAttr("type"))return!0
...
return"HEADER"===o||"FOOTER"===o?!Yr(e,n):"SECTION"===o||"FORM"===o?!!sl(e):r.indexOf(a)>=0||"region"===a}(t)&&sa(e,!0)},"layout-table-matches":function(e){return!ru(e)&&!Ia(e)},"link-in-text-block-matches":function(e){var t=ya(e.textContent),n=e.getAttribute("role")
...
var r=t.attr("id")
if(r){var a=$r(e)
if(Array.from(a.querySelectorAll('[aria-owns~="'.concat(r,'"], [aria-controls~="').concat(r,'"]'))).some((function(e){return Oi(e.getAttribute("role")).includes("combobox")})))return!1}}return!!Ei(t,"*").some((function(e){return Fa(e,!0,!0)}))},"skip-link-matches":function(e){return eo(e)&&aa(e)},"svg-namespace-matches":oc,"window-is-top-matches":function(e){return e.ownerDocument.defaultView.self===e.ownerDocument.defaultView.top},"xml-lang-mismatch-matches":function(e){var t=go(e.getAttribute("lang")),n=go(e.getAttribute("xml:lang"))
...
var fc=pc,hc=function(e){this.id=e.id,this.result=Tt.NA,this.pageLevel=e.pageLevel,this.impact=null,this.nodes=[]}
...
var i=Ti(this.selector,e)
return this.excludeHidden&&(t.performanceTimer&&si.mark(a),i=i.filter((function(e){return!zo(e.actualNode)})),t.performanceTimer&&(si.mark(o),si.measure("rule_"+this.id+"#gather_axe.utils.isHidden",a,o))),t.performanceTimer&&(si.mark(r),si.measure("rule_"+this.id+"#gather",n,r)),i},mc.prototype.runChecks=function(e,t,n,r,a,o){var i=this,s=Fr()
...
var o,i=Fr(),l=new hc(this)
try{o=this.gatherAndMatchNodes(e,n)}catch(e){return void a(new s({cause:e,ruleId:this.id}))}n.performanceTimer&&this._logGatherPerformance(o),o.forEach((function(r){i.defer((function(a,o){var i=Fr();["any","all","none"].forEach((function(a){i.defer((function(o,i){t.runChecks(a,r,n,e,o,i)}))})),i.then((function(e){var o=gc(e)
...
this.data.checks[l]=(t=this.data.checks[l],r=void 0,a=void 0,r=(n=e[l]).pass,a=n.fail,"string"==typeof r&&yc.test(r)&&(r=bc.default.compile(r)),"string"==typeof a&&yc.test(a)&&(a=bc.default.compile(a)),S({},t,{messages:{pass:r||t.messages.pass,fail:a||t.messages.fail,incomplete:"object"===o(t.messages.incomplete)?S({},t.messages.incomplete,n.incomplete):n.incomplete}}))}}},{key:"_applyRuleLocale",value:function(e){for(var t,n,r,a,o=Object.keys(e),i=0;i<o.length;i++){var s=o[i]
if(!this.data.rules[s])throw new Error('Locale provided for unknown rule: "'.concat(s,'"'))
this.data.rules[s]=(t=this.data.rules[s],r=void 0,a=void 0,r=(n=e[s]).help,a=n.description,"string"==typeof r&&yc.test(r)&&(r=bc.default.compile(r)),"string"==typeof a&&yc.test(a)&&(a=bc.default.compile(a)),S({},t,{help:r||t.help,description:a||t.description}))}}},{key:"_applyFailureSummaries",value:function(e){for(var t,n,r=Object.keys(e),a=0;a<r.length;a++){var o=r[a]
if(!this.data.failureSummaries[o])throw new Error('Locale provided for unknown failureMessage: "'.concat(o,'"'))
this.data.failureSummaries[o]=(t=this.data.failureSummaries[o],n=void 0,"string"==typeof(n=e[o].failureMessage)&&yc.test(n)&&(n=bc.default.compile(n)),S({},t,{failureMessage:n||t.failureMessage}))}}},{key:"applyLocale",value:function(e){var t,n
this._setDefaultLocale(),e.checks&&this._applyCheckLocale(e.checks),e.rules&&this._applyRuleLocale(e.rules),e.failureSummaries&&this._applyFailureSummaries(e.failureSummaries,"failureSummaries"),e.incompleteFallbackMessage&&(this.data.incompleteFallbackMessage=(t=this.data.incompleteFallbackMessage,"string"==typeof(n=e.incompleteFallbackMessage)&&yc.test(n)&&(n=bc.default.compile(n)),n||t)),e.lang&&(this.lang=e.lang)}},{key:"setAllowedOrigins",value:function(e){var t=wc()
this.allowedOrigins=[]
var n,r=M(e)
...
var a=function(e,t,n){return e.reduce((function(e,r){return Ci(r,t,n)?r.preload?(e.later.push(r),e):(e.now.push(r),e):e}),{now:[],later:[]})}(this.rules,e,t),o=a.now,s=a.later,l=Fr()
...
else{var o=Object.assign(new hc(e),{result:Tt.CANTTELL,description:"An error occured while running this rule",message:t.message,stack:t.stack,error:t,errorNode:t.errorNode})
r(o)}}))}}function Ac(e,t,n){var r=e.brand,a=e.application,o=e.lang
return Tt.helpUrlBase+r+"/"+(n||i.version.substring(0,i.version.lastIndexOf(".")))+"/"+t+"?application="+encodeURIComponent(a)+(o&&"en"!==o?"&lang="+encodeURIComponent(o):"")}var Cc=xc,kc={}
B(kc,{CssSelectorParser:function(){return Fc.CssSelectorParser},doT:function(){return Tc.default},emojiRegexText:function(){return Nc.default},memoize:function(){return Rc.default}})
var Fc=U($()),Tc=U(Et()),Nc=U(xt()),Rc=U(Dt()),_c=U(At()),Oc=U(Ct())
U(kt()),Tc.default.templateSettings.strip=!1,"Promise"in n||_c.default.polyfill(),"Uint32Array"in n||(n.Uint32Array=Oc.Uint32Array),n.Uint32Array&&("some"in n.Uint32Array.prototype||Object.defineProperty(n.Uint32Array.prototype,"some",{value:Array.prototype.some}),"reduce"in n.Uint32Array.prototype||Object.defineProperty(n.Uint32Array.prototype,"reduce",{value:Array.prototype.reduce}))
var Sc,Ic=function(e,t){if(e=e||function(){},t=t||i.log,!i._audit)throw new Error("No audit configured")
...
function jc(e){return Pc.hasOwnProperty(e)}function Mc(e){return"string"==typeof e&&Pc[e]?Pc[e]:"function"==typeof e?e:Sc}function qc(e){var t=n&&"Node"in n&&"NodeList"in n,r=!!a
...
r||(tr.set("globalDocumentSet",!0),a=e.ownerDocument),t||(tr.set("globalWindowSet",!0),n=a.defaultView)}}function Lc(){tr.get("globalDocumentSet")&&(tr.set("globalDocumentSet",!1),a=null),tr.get("globalWindowSet")&&(tr.set("globalWindowSet",!1),n=null)}var Bc=function(){Lc(),i._memoizedFns.forEach((function(e){return e.clear()})),tr.clear(),i._tree=void 0,i._selectorData=void 0,i._selectCache=void 0},Uc=function(e,t,n,r){try{e=new So(e),i._tree=e.flatTree,i._selectorData=Vn(e.flatTree)}catch(e){return Bc(),r(e)}var a=Fr(),o=i._audit
t.performanceTimer&&si.auditStart(),e.frames.length&&!1!==t.iframes&&a.defer((function(n,r){qr(e,t,"rules",null,n,r)})),a.defer((function(n,r){o.run(e,t,n,r)})),a.then((function(a){try{t.performanceTimer&&si.auditEnd()
var i=Mr(a.map((function(e){return{results:e}})))
e.initiator&&((i=o.after(i,t)).forEach(xi),i=i.map(bn))
try{n(i,Bc)}catch(e){Bc(),Nt(e)}}catch(e){Bc(),r(e)}})).catch((function(e){Bc(),r(e)}))}
function Hc(e){this._run=e.run,this._collect=e.collect,this._registry={},e.commands.forEach((function(e){i._audit.registerCommand(e)}))}function Vc(e){var t,r,s,l=O(e,3),u=l[0],c=l[1],d=l[2],p=new TypeError("axe.run arguments are invalid")
...
return(c=sr(c)).reporter=null!==(t=null!==(r=c.reporter)&&void 0!==r?r:null===(s=i._audit)||void 0===s?void 0:s.reporter)&&void 0!==t?t:"v1",{context:u,options:c,callback:d}}n.top!==n&&(Nr.subscribe("axe.start",(function(e,t,n){var r=n,o=function(e){e instanceof Error==0&&(e=new Error(e)),n(e)},s=e&&e.context||{}
s.hasOwnProperty("include")&&!s.include.length&&(s.include=[a])
var l=e&&e.options||{}
switch(e.command){case"rules":return Uc(s,l,(function(e,t){r(e),t()}),o)
case"cleanup-plugin":return Ic(r,o)
default:if(i._audit&&i._audit.commands&&i._audit.commands[e.command])return i._audit.commands[e.command](e,n)}})),Nr.subscribe("axe.ping",(function(e,t,n){n({axe:!0})}))),Hc.prototype.run=function(){return this._run.apply(this,arguments)},Hc.prototype.collect=function(){return this._collect.apply(this,arguments)},Hc.prototype.cleanup=function(e){var t=i.utils.queue(),n=this
Object.keys(this._registry).forEach((function(e){t.defer((function(t){n._registry[e].cleanup(t)}))})),t.then(e)},Hc.prototype.add=function(e){this._registry[e.id]=e}
var zc=function(){}
function $c(e){var t,n,r
...
return S({},R(e,v),{relatedNodes:t.map((function(e){return e.toJSON()}))})}))}return n}function Qc(e){var t,n=[],r=M(e)
...
return n?t.map((function(e){return or.mergeSpecs(e,n)})):t}function Jc(e,t){return new Promise((function(n){Mc(t.reporter)(e,t,n)}))}var Xc=function(e,t,n){if("function"==typeof t&&(n=t,t={}),!e||!Array.isArray(e))return n(e)
...
i.constants=Tt,i.log=Nt,i.AbstractVirtualNode=_t,i.SerialVirtualNode=Bi,i.VirtualNode=fo,i._cache=tr,i._thisWillBeDeletedDoNotUse=i._thisWillBeDeletedDoNotUse||{},i._thisWillBeDeletedDoNotUse.base={Audit:Cc,CheckResult:uc,Check:fc,Context:So,RuleResult:hc,Rule:vc,metadataFunctionMap:lc},i._thisWillBeDeletedDoNotUse.public={reporters:Pc},i.imports=kc,i.cleanup=Ic,i.configure=function(e){var t
...
y.push(e.id),t.addRule(e)}))}if(e.disableOtherRules&&t.rules.forEach((function(e){!1===y.includes(e.id)&&(e.enabled=!1)})),void 0!==e.branding?t.setBranding(e.branding):t._constructHelpUrls(),e.tagExclude&&(t.tagExclude=e.tagExclude),e.locale&&t.applyLocale(e.locale),e.standards&&(b=e.standards,Object.keys(Qa).forEach((function(e){b[e]&&(Qa[e]=Br(Qa[e],b[e]))}))),e.noHtml&&(t.noHtml=!0),e.allowedOrigins){if(!Array.isArray(e.allowedOrigins))throw new TypeError("Allowed origins property must be an array")
...
return{ruleId:e.id,description:t.description,help:t.help,helpUrl:t.helpUrl,tags:e.tags}}))},i._load=function(e){i._audit=new Cc(e)},i.plugins={},i.registerPlugin=function(e){i.plugins[e.id]=new Hc(e)},i.hasReporter=jc,i.getReporter=Mc,i.addReporter=function(e,t,n){Pc[e]=t,n&&(Sc=t)},i.reset=function(){var e=i._audit
if(!e)throw new Error("No audit configured")
e.resetRulesAndChecks(),Object.keys(Qa).forEach((function(e){Qa[e]=Ya[e]}))},i._runRules=Uc,i.runVirtualRule=function(e,t){var n=arguments.length>2&&void 0!==arguments[2]?arguments[2]:{}
...
xi(o),bn(o)
var s=Dn([o])
return s.violations.forEach((function(e){return e.nodes.forEach((function(e){e.failureSummary=vo(e)}))})),S({},ko(),s,{toolOptions:n})},i.run=function(){for(var e=arguments.length,t=new Array(e),n=0;n<e;n++)t[n]=arguments[n]
qc(t[0])
var r=Vc(t),a=r.context,o=r.options,s=r.callback,l=void 0===s?zc:s,u=$c(l),c=u.thenable,d=u.resolve,p=u.reject
...
return i._tree=mo(e),i._selectorData=Vn(i._tree),i._tree[0]},i.teardown=Bc,i.runPartial=function(){for(var e=arguments.length,t=new Array(e),n=0;n<e;n++)t[n]=arguments[n]
var r=Vc(t),a=r.options,o=r.context
...
var s=new So(o,i._tree)
return i._tree=s.flatTree,i._selectorData=Vn(s.flatTree),i._running=!0,new Promise((function(e,t){i._audit.run(s,a,e,t)})).then((function(e){e=e.map((function(e){var t=e.nodes,n=R(e,m)
return S({nodes:t.map(Yc)},n)}))
...
var a=function(){if("undefined"!=typeof globalThis)return globalThis
if("undefined"!=typeof self)return self
if(void 0!==o)return o
if("undefined"!=typeof global)return global
throw new Error("Unable to locate global object")}(),o=a.window,i=a.console,s=a.setTimeout,l=a.clearTimeout,u=o&&o.document,c=o&&o.navigator,d=function(){var e="qunit-test-string"
try{return a.sessionStorage.setItem(e,e),a.sessionStorage.removeItem(e),a.sessionStorage}catch(e){return}}(),p="function"==typeof a.Map?a.Map:function(){var e=Object.create(null),t=Object.prototype.hasOwnProperty
...
function f(e){return f="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},f(e)}function h(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function m(e,t){for(var n=0;n<t.length;n++){var r=t[n]
r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}function g(e,t,n){return t&&m(e.prototype,t),n&&m(e,n),e}function v(e,t){return function(e){if(Array.isArray(e))return e}(e)||function(e,t){var n=null==e?null:"undefined"!=typeof Symbol&&e[Symbol.iterator]||e["@@iterator"]
if(null!=n){var r,a,o=[],i=!0,s=!1
try{for(n=n.call(e);!(i=(r=n.next()).done)&&(o.push(r.value),!t||o.length!==t);i=!0);}catch(e){s=!0,a=e}finally{try{i||null==n.return||n.return()}finally{if(s)throw a}}return o}}(e,t)||y(e,t)||function(){throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}()}function b(e){return function(e){if(Array.isArray(e))return w(e)}(e)||function(e){if("undefined"!=typeof Symbol&&null!=e[Symbol.iterator]||null!=e["@@iterator"])return Array.from(e)}(e)||y(e)||function(){throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}()}function y(e,t){if(e){if("string"==typeof e)return w(e,t)
var n=Object.prototype.toString.call(e).slice(8,-1)
...
for(var n=0,r=new Array(t);n<t;n++)r[n]=e[n]
return r}var D={warn:i?Function.prototype.bind.call(i.warn||i.log,i):function(){}},x=Object.prototype.toString,E=Object.prototype.hasOwnProperty,A=Date.now||function(){return(new Date).getTime()},C=o&&void 0!==o.performance&&"function"==typeof o.performance.mark&&"function"==typeof o.performance.measure?o.performance:void 0,k={now:C?C.now.bind(C):A,measure:C?function(e,t,n){try{C.measure(e,t,n)}catch(e){D.warn("performance.measure could not be executed because of ",e.message)}}:function(){},mark:C?C.mark.bind(C):function(){}}
...
var n={}
for(var r in t)E.call(t,r)&&E.call(e,r)&&(n[r]=R(e[r],t[r]))
return n}function _(e,t,n){for(var r in t)E.call(t,r)&&(void 0===t[r]?delete e[r]:n&&void 0!==e[r]||(e[r]=t[r]))
...
default:return f(e)}}function S(e,t){return O(t)===e}function I(e,t){for(var n=e+""+t,r=0,a=0;a<n.length;a++)r=(r<<5)-r+n.charCodeAt(a),r|=0
var o=(4294967296+r).toString(16)
return o.length<8&&(o="0000000"+o),o.slice(-8)}function P(e){var t=String(e)
return"[object"===t.slice(0,7)?(e.name||"Error")+(e.message?": ".concat(e.message):""):t}var j=function(){var e=[],t=Object.getPrototypeOf||function(e){return e.__proto__}
function n(e,t){return"object"===f(e)&&(e=e.valueOf()),"object"===f(t)&&(t=t.valueOf()),e===t}function r(e){return"flags"in e?e.flags:e.toString().match(/[gimuy]*$/)[0]}function a(t,n){return t===n||(-1===["object","array","map","set"].indexOf(O(t))?i(t,n):(e.every((function(e){return e.a!==t||e.b!==n}))&&e.push({a:t,b:n}),!0))}var o={string:n,boolean:n,number:n,null:n,undefined:n,symbol:n,date:n,nan:function(){return!0},regexp:function(e,t){return e.source===t.source&&r(e)===r(t)},function:function(){return!1},array:function(e,t){var n=e.length
...
s([n,r],[t,a])&&(o=!0),e=i}})),o||(r=!1)}})),r},object:function(e,n){if(!1===function(e,n){var r=t(e),a=t(n)
...
var r=[],o=[]
for(var s in e)if(r.push(s),(e.constructor===Object||void 0===e.constructor||"function"!=typeof e[s]||"function"!=typeof n[s]||e[s].toString()!==n[s].toString())&&!a(e[s],n[s]))return!1
for(var l in n)o.push(l)
return i(r.sort(),o.sort())}}
function i(e,t){var n=O(e)
return O(t)===n&&o[n](e,t)}function s(t,n){if(arguments.length<2)return!0
e=[{a:t,b:n}]
...
return e.length=0,t}}(),M={queue:[],stats:{all:0,bad:0,testCount:0},blocking:!0,failOnZeroTests:!0,reorder:!0,altertitle:!0,collapse:!0,scrolltop:!0,maxDepth:5,requireExpects:!1,urlConfig:[],modules:[],currentModule:{name:"",tests:[],childModules:[],testsRun:0,testsIgnored:0,hooks:{before:[],beforeEach:[],afterEach:[],after:[]}},globalHooks:{},callbacks:{},storage:d},q=a&&a.QUnit&&!a.QUnit.version&&a.QUnit.config
q&&_(M,q),M.modules.push(M.currentModule)
var L=function(){function e(e){return'"'+e.toString().replace(/\\/g,"\\\\").replace(/"/g,'\\"')+'"'}function t(e){return e+""}function n(e,t,n){var r=o.separator(),a=o.indent(1)
...
return t=null===e?"null":void 0===e?"undefined":S("regexp",e)?"regexp":S("date",e)?"date":S("function",e)?"function":void 0!==e.setInterval&&void 0!==e.document&&void 0===e.nodeType?"window":9===e.nodeType?"document":e.nodeType?"node":function(e){return"[object Array]"===x.call(e)||"number"==typeof e.length&&void 0!==e.item&&(e.length?e.item(0)===e[0]:null===e.item(0)&&void 0===e[0])}(e)?"array":e.constructor===Error.prototype.constructor?"error":f(e),t},separator:function(){return this.multiline?this.HTML?"<br />":"\n":this.HTML?"&#160;":" "},indent:function(e){if(!this.multiline)return""
...
return o}(),B=function(){function e(t,n){h(this,e),this.name=t,this.fullName=n?n.fullName.concat(t):[],this.globalFailureCount=0,this.tests=[],this.childSuites=[],n&&n.pushChildSuite(this)}return g(e,[{key:"start",value:function(e){if(e){this._startTime=k.now()
var t=this.fullName.length
k.mark("qunit_suite_".concat(t,"_start"))}return{name:this.name,fullName:this.fullName.slice(),tests:this.tests.map((function(e){return e.start()})),childSuites:this.childSuites.map((function(e){return e.start()})),testCounts:{total:this.getTestCounts().total}}}},{key:"end",value:function(e){if(e){this._endTime=k.now()
var t=this.fullName.length,n=this.fullName.join(" – ")
k.mark("qunit_suite_".concat(t,"_end")),k.measure(0===t?"QUnit Test Run":"QUnit Test Suite: ".concat(n),"qunit_suite_".concat(t,"_start"),"qunit_suite_".concat(t,"_end"))}return{name:this.name,fullName:this.fullName.slice(),tests:this.tests.map((function(e){return e.end()})),childSuites:this.childSuites.map((function(e){return e.end()})),testCounts:this.getTestCounts(),runtime:this.getRuntime(),status:this.getStatus()}}},{key:"pushChildSuite",value:function(e){this.childSuites.push(e)}},{key:"pushTest",value:function(e){this.tests.push(e)}},{key:"getRuntime",value:function(){return this._endTime-this._startTime}},{key:"getTestCounts",value:function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{passed:0,failed:0,skipped:0,todo:0,total:0}
return e.failed+=this.globalFailureCount,e.total+=this.globalFailureCount,e=this.tests.reduce((function(e,t){return t.valid&&(e[t.getStatus()]++,e.total++),e}),e),this.childSuites.reduce((function(e,t){return t.getTestCounts(e)}),e)}},{key:"getStatus",value:function(){var e=this.getTestCounts(),t=e.total,n=e.failed,r=e.skipped,a=e.todo
return n?"failed":r===t?"skipped":a===t?"todo":"passed"}}]),e}(),U=[],H=new B
function V(e,t,n){var r=U.length?U.slice(-1)[0]:null,a=null!==r?[r.name,e].join(" > "):e,o=r?r.suiteReport:H,i=null!==r&&r.skip||n.skip,s=null!==r&&r.todo||n.todo,l={}
r&&_(l,r.testEnvironment),_(l,t)
var u={name:a,parentModule:r,hooks:{before:[],beforeEach:[],afterEach:[],after:[]},testEnvironment:l,tests:[],moduleId:I(a),testsRun:0,testsIgnored:0,childModules:[],suiteReport:new B(e,o),stats:null,skip:i,todo:!i&&s,ignored:n.ignored||!1}
return r&&r.childModules.push(u),M.modules.push(u),u}function z(e,t,n){var r=t[n]
"function"==typeof r&&e[n].push(r),delete t[n]}function $(e,t){return function(n){M.currentModule!==e&&D.warn("The `"+t+"` hook was called inside the wrong module (`"+M.currentModule.name+"`). Instead, use hooks provided by the callback to the containing module (`"+e.name+"`). This will become an error in QUnit 3.0."),e.hooks[t].push(n)}}function W(e,t,n){var r=arguments.length>3&&void 0!==arguments[3]?arguments[3]:{}
...
var s={before:$(a,"before"),beforeEach:$(a,"beforeEach"),afterEach:$(a,"afterEach"),after:$(a,"after")},l=M.currentModule
if(M.currentModule=a,"function"===O(n)){U.push(a)
try{var u=n.call(a.testEnvironment,s)
null!=u&&"function"===O(u.then)&&D.warn("Returning a promise from a module callback is not supported. Instead, use hooks for async behavior. This will become an error in QUnit 3.0.")}finally{U.pop(),M.currentModule=a.parentModule||l}}}var G=!1
function Y(e,t,n){var r,a=G&&(r=M.modules.filter((function(e){return!e.ignored})).map((function(e){return e.moduleId})),!U.some((function(e){return r.includes(e.moduleId)})))
W(e,t,n,{ignored:a})}Y.only=function(){G||(M.modules.length=0,M.queue.length=0,M.currentModule.ignored=!0),G=!0,W.apply(void 0,arguments)},Y.skip=function(e,t,n){G||W(e,t,n,{skip:!0})},Y.todo=function(e,t,n){G||W(e,t,n,{todo:!0})}
var Q=(J(0)||"").replace(/(:\d+)+\)?/,"").replace(/.+\//,"")
function K(e,t){if(t=void 0===t?4:t,e&&e.stack){var n=e.stack.split("\n")
if(/^error$/i.test(n[0])&&n.shift(),Q){for(var r=[],a=t;a<n.length&&-1===n[a].indexOf(Q);a++)r.push(n[a])
if(r.length)return r.join("\n")}return n[t]}}function J(e){var t=new Error
if(!t.stack)try{throw t}catch(e){t=e}return K(t,e)}var X=function(){function e(t){h(this,e),this.test=t}return g(e,[{key:"timeout",value:function(e){if("number"!=typeof e)throw new Error("You must pass a number as the duration to assert.timeout")
this.test.timeout=e,M.timeout&&(l(M.timeout),M.timeout=null,M.timeoutHandler&&this.test.timeout>0&&this.test.internalResetTimeout(this.test.timeout))}},{key:"step",value:function(e){var t=e,n=!!e
...
this.pushResult({result:r,actual:e,expected:t,message:n,negative:!0})}},{key:"propEqual",value:function(e,t,n){e=N(e),t=N(t),this.pushResult({result:j(e,t),actual:e,expected:t,message:n})}},{key:"notPropEqual",value:function(e,t,n){e=N(e),t=N(t),this.pushResult({result:!j(e,t),actual:e,expected:t,message:n,negative:!0})}},{key:"propContains",value:function(e,t,n){e=R(e,t),t=N(t,!1),this.pushResult({result:j(e,t),actual:e,expected:t,message:n})}},{key:"notPropContains",value:function(e,t,n){e=R(e,t),t=N(t),this.pushResult({result:!j(e,t),actual:e,expected:t,message:n,negative:!0})}},{key:"deepEqual",value:function(e,t,n){this.pushResult({result:j(e,t),actual:e,expected:t,message:n})}},{key:"notDeepEqual",value:function(e,t,n){this.pushResult({result:!j(e,t),actual:e,expected:t,message:n,negative:!0})}},{key:"strictEqual",value:function(e,t,n){this.pushResult({result:t===e,actual:e,expected:t,message:n})}},{key:"notStrictEqual",value:function(e,t,n){this.pushResult({result:t!==e,actual:e,expected:t,message:n,negative:!0})}},{key:"throws",value:function(t,n,r){var a=v(Z(n,r,"throws"),2)
n=a[0],r=a[1]
var o=this instanceof e&&this.test||M.current
if("function"===O(t)){var i,s=!1
o.ignoreGlobalErrors=!0
try{t.call(o.testEnvironment)}catch(e){i=e}if(o.ignoreGlobalErrors=!1,i){var l=v(ee(i,n,r),3)
...
o.assert.pushResult({result:!1,actual:t,message:u})}}},{key:"rejects",value:function(t,n,r){var a=v(Z(n,r,"rejects"),2)
n=a[0],r=a[1]
...
o.assert.pushResult({result:!1,message:e,actual:t}),s()}),(function(e){var t,a=v(ee(e,n,r),3)
...
return[e,t]}function ee(e,t,n){var r=!1,a=O(t)
...
function re(e,t){if("string"!==O(e))throw new TypeError("eventName must be a string when emitting an event")
for(var n=te[e],r=n?b(n):[],a=0;a<r.length;a++)r[a](t)}var ae="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof self?self:{},oe={exports:{}}
...
return o(this,new u(e,t,n)),n},a.prototype.finally=function(e){var t=this.constructor
...
var o=a.length
function i(e,n){try{if(n&&("object"===f(n)||"function"==typeof n)){var s=n.then
if("function"==typeof s)return void s.call(n,(function(t){i(e,t)}),r)}a[e]=n,0==--o&&t(a)}catch(e){r(e)}}for(var s=0;s<a.length;s++)i(s,a[s])}))},a.allSettled=function(e){return new this((function(t,n){if(!e||void 0===e.length)return n(new TypeError(f(e)+" "+e+" is not iterable(cannot read property Symbol(Symbol.iterator))"))
var r=Array.prototype.slice.call(e)
if(0===r.length)return t([])
var a=r.length
function o(e,n){if(n&&("object"===f(n)||"function"==typeof n)){var i=n.then
if("function"==typeof i)return void i.call(n,(function(t){o(e,t)}),(function(n){r[e]={status:"rejected",reason:n},0==--a&&t(r)}))}r[e]={status:"fulfilled",value:n},0==--a&&t(r)}for(var i=0;i<r.length;i++)o(i,r[i])}))},a.resolve=function(e){return e&&"object"===f(e)&&e.constructor===a?e:new a((function(t){t(e)}))},a.reject=function(e){return new a((function(t,n){n(e)}))},a.race=function(e){return new a((function(t,r){if(!n(e))return r(new TypeError("Promise.race accepts an array"))
for(var o=0,i=e.length;o<i;o++)a.resolve(e[o]).then(t,r)}))},a._immediateFn="function"==typeof setImmediate&&function(e){setImmediate(e)}||function(e){t(e,0)},a._unhandledRejectionFn=function(e){"undefined"!=typeof console&&console&&console.warn("Possible Unhandled Promise Rejection:",e)},oe.exports=a}else oe.exports=e.Promise
...
if(null!==n){var r
try{r=n(e._value)}catch(e){return void s(t.promise,e)}i(t.promise,r)}else(1===e._state?i:s)(t.promise,e._value)}))):e._deferreds.push(t)}function i(e,t){try{if(t===e)throw new TypeError("A promise cannot be resolved with itself.")
if(t&&("object"===f(t)||"function"==typeof t)){var n=t.then
if(t instanceof a)return e._state=3,e._value=t,void l(e)
if("function"==typeof n)return void c((r=n,o=t,function(){r.apply(o,arguments)}),e)}e._state=1,e._value=t,l(e)}catch(t){s(e,t)}var r,o}function s(e,t){e._state=2,e._value=t,l(e)}function l(e){2===e._state&&0===e._deferreds.length&&a._immediateFn((function(){e._handled||a._unhandledRejectionFn(e._value)}))
...
n=!0,s(t,e)}}}()
var ie=oe.exports
function se(e,t){var n=M.callbacks[e]
if("log"!==e)return n.reduce((function(e,n){return e.then((function(){return ie.resolve(n(t))}))}),ie.resolve([]))
n.map((function(e){return e(t)}))}var le,ue=0,ce=[]
function de(){var e,t
e=A(),M.depth=(M.depth||0)+1,pe(e),M.depth--,ce.length||M.blocking||M.current||(M.blocking||M.queue.length||0!==M.depth?(t=M.queue.shift()(),ce.push.apply(ce,b(t)),ue>0&&ue--,de()):function(){var e
if(0===M.stats.testCount&&!0===M.failOnZeroTests)return e=M.filter&&M.filter.length?new Error('No tests matched the filter "'.concat(M.filter,'".')):M.module&&M.module.length?new Error('No tests matched the module "'.concat(M.module,'".')):M.moduleId&&M.moduleId.length?new Error('No tests matched the moduleId "'.concat(M.moduleId,'".')):M.testId&&M.testId.length?new Error('No tests matched the testId "'.concat(M.testId,'".')):new Error("No tests were run."),De("global failure",_((function(t){t.pushResult({result:!1,message:e.message,source:e.stack})}),{validTest:!0})),void de()
var t=M.storage,n=A()-M.started,r=M.stats.all-M.stats.bad
fe.finished=!0,re("runEnd",H.end(!0)),se("done",{passed:r,failed:M.stats.bad,total:M.stats.all,runtime:n}).then((function(){if(t&&0===M.stats.bad)for(var e=t.length-1;e>=0;e--){var n=t.key(e)
0===n.indexOf("qunit-test-")&&t.removeItem(n)}}))}())}function pe(e){if(ce.length&&!M.blocking){var t=A()-e
if(!s||M.updateRate<=0||t<M.updateRate){var n=ce.shift()
ie.resolve(n()).then((function(){ce.length?pe(e):de()}))}else s(de)}}var fe={finished:!1,add:function(e,t,n){if(t)M.queue.splice(ue++,0,e)
else if(n){le||(le=function(e){var t=parseInt(I(e),16)||-1
return function(){return t^=t<<13,t^=t>>>17,(t^=t<<5)<0&&(t+=4294967296),t/4294967296}}(n))
var r=Math.floor(le()*(M.queue.length-ue+1))
M.queue.splice(ue+r,0,e)}else M.queue.push(e)},advance:de,taskCount:function(){return ce.length}},he=function(){function e(t,n,r){h(this,e),this.name=t,this.suiteName=n.name,this.fullName=n.fullName.concat(t),this.runtime=0,this.assertions=[],this.skipped=!!r.skip,this.todo=!!r.todo,this.valid=r.valid,this._startTime=0,this._endTime=0,n.pushTest(this)}return g(e,[{key:"start",value:function(e){return e&&(this._startTime=k.now(),k.mark("qunit_test_start")),{name:this.name,suiteName:this.suiteName,fullName:this.fullName.slice()}}},{key:"end",value:function(e){if(e&&(this._endTime=k.now(),k)){k.mark("qunit_test_end")
var t=this.fullName.join(" – ")
k.measure("QUnit Test: ".concat(t),"qunit_test_start","qunit_test_end")}return _(this.start(),{runtime:this.getRuntime(),status:this.getStatus(),errors:this.getFailedAssertions(),assertions:this.getAssertions()})}},{key:"pushAssertion",value:function(e){this.assertions.push(e)}},{key:"getRuntime",value:function(){return this._endTime-this._startTime}},{key:"getStatus",value:function(){return this.skipped?"skipped":(this.getFailedAssertions().length>0?this.todo:!this.todo)?this.todo?"todo":"passed":"failed"}},{key:"getFailedAssertions",value:function(){return this.assertions.filter((function(e){return!e.passed}))}},{key:"getAssertions",value:function(){return this.assertions.slice()}},{key:"slimAssertions",value:function(){this.assertions=this.assertions.map((function(e){return delete e.actual,delete e.expected,e}))}}]),e}()
function me(e){if(this.expected=null,this.assertions=[],this.module=M.currentModule,this.steps=[],this.timeout=void 0,this.data=void 0,this.withData=!1,this.pauses=new p,this.nextPauseId=1,this.stackOffset=3,_(this,e),this.module.skip?(this.skip=!0,this.todo=!1):this.module.todo&&!this.skip&&(this.todo=!0),fe.finished)D.warn("Unexpected test after runEnd. This is unstable and will fail in QUnit 3.0.")
else{if(!this.skip&&"function"!=typeof this.callback){var t=this.todo?"QUnit.todo":"QUnit.test"
throw new TypeError("You must provide a callback to ".concat(t,'("').concat(this.testName,'")'))}++me.count,this.errorForStack=new Error,this.callback&&this.callback.validTest&&(this.errorForStack.stack=void 0),this.testReport=new he(this.testName,this.module.suiteReport,{todo:this.todo,skip:this.skip,valid:this.valid()})
for(var n=0,r=this.module.tests;n<r.length;n++)this.module.tests[n].name===this.testName&&(this.testName+=" ")
this.testId=I(this.module.name,this.testName),this.module.tests.push({name:this.testName,testId:this.testId,skip:!!this.skip}),this.skip?(this.callback=function(){},this.async=!1,this.expected=0):this.assert=new X(this)}}function ge(){if(!M.current)throw new Error("pushFailure() assertion outside test context, in "+J(2))
var e=M.current
return e.pushFailure.apply(e,arguments)}function ve(){if(M.pollution=[],M.noglobals)for(var e in a)if(E.call(a,e)){if(/^qunit-test-output/.test(e))continue
M.pollution.push(e)}}me.count=0,me.prototype={get stack(){return K(this.errorForStack,this.stackOffset)},before:function(){var e=this,t=this.module,n=function(e){for(var t=e,n=[];t&&0===t.testsRun;)n.push(t),t=t.parentModule
return n.reverse()}(t)
return n.reduce((function(e,t){return e.then((function(){return t.stats={all:0,bad:0,started:A()},re("suiteStart",t.suiteReport.start(!0)),se("moduleStart",{name:t.name,tests:t.tests})}))}),ie.resolve([])).then((function(){return M.current=e,e.testEnvironment=_({},t.testEnvironment),e.started=A(),re("testStart",e.testReport.start(!0)),se("testStart",{name:e.testName,module:t.name,testId:e.testId,previousFailure:e.previousFailure}).then((function(){M.pollution||ve()}))}))},run:function(){if(M.current=this,this.callbackStarted=A(),M.notrycatch)e(this)
else try{e(this)}catch(e){this.pushFailure("Died on test #"+(this.assertions.length+1)+": "+(e.message||e)+"\n"+this.stack,K(e,0)),ve(),M.blocking&&Ae(this)}function e(e){var t
t=e.withData?e.callback.call(e.testEnvironment,e.assert,e.data):e.callback.call(e.testEnvironment,e.assert),e.resolvePromise(t),0===e.timeout&&e.pauses.size>0&&ge("Test did not finish synchronously even though assert.timeout( 0 ) was used.",J(2))}},after:function(){!function(){var e=M.pollution
ve()
...
else try{r=e.call(n.testEnvironment,n.assert)}catch(e){return void n.pushFailure("Global "+t+" failed on "+n.testName+": "+P(e),K(e,0))}n.resolvePromise(r,t)}},queueHook:function(e,t,n){var r=this,a=function(){var n=e.call(r.testEnvironment,r.assert)
r.resolvePromise(n,t)}
return function(){if("before"===t){if(0!==n.testsRun)return
r.preserveEnvironment=!0}if("after"!==t||function(e){return e.testsRun===ke(e).filter((function(e){return!e.skip})).length-1}(n)||!(M.queue.length>0||fe.taskCount()>2))if(M.current=r,M.notrycatch)a()
else try{a()}catch(e){r.pushFailure(t+" failed on "+r.testName+": "+(e.message||e),K(e,0))}}},hooks:function(e){var t=[]
...
this.runtime=A()-this.started,M.stats.all+=this.assertions.length,M.stats.testCount+=1,t.stats.all+=this.assertions.length
for(var l=0;l<this.assertions.length;l++)this.assertions[l].result||(i++,M.stats.bad++,t.stats.bad++)
a?Te(t):function(e){for(e.testsRun++;e=e.parentModule;)e.testsRun++}(t),s&&(i?s.setItem("qunit-test-"+n+"-"+r,i):s.removeItem("qunit-test-"+n+"-"+r)),re("testEnd",this.testReport.end(!0)),this.testReport.slimAssertions()
var u=this
...
n.hooks={},t.push.apply(t,b(n.childModules))}return re("suiteEnd",e.suiteReport.end(!0)),se("moduleDone",{name:e.name,tests:e.tests,failed:e.stats.bad,passed:e.stats.all-e.stats.bad,total:e.stats.all,runtime:A()-e.stats.started})}(t)}))}),ie.resolve([]))}})).then((function(){M.current=void 0}))},preserveTestEnvironment:function(){this.preserveEnvironment&&(this.module.testEnvironment=this.testEnvironment,this.testEnvironment=_({},this.module.testEnvironment))},queue:function(){var e=this
if(this.valid()){var t=M.storage&&+M.storage.getItem("qunit-test-"+this.module.name+"-"+this.testName),n=M.reorder&&!!t
this.previousFailure=!!t,fe.add((function(){return[function(){return e.before()}].concat(b(e.hooks("before")),[function(){e.preserveTestEnvironment()}],b(e.hooks("beforeEach")),[function(){e.run()}],b(e.hooks("afterEach").reverse()),b(e.hooks("after").reverse()),[function(){e.after()},function(){return e.finish()}])}),n,M.seed)}else Te(this.module)},pushResult:function(e){if(this!==M.current){var t=e&&e.message||"",n=this&&this.testName||""
throw new Error("Assertion occurred after test finished.\n> Test: "+n+"\n> Message: "+t+"\n")}var r={module:this.module.name,name:this.testName,result:e.result,message:e.message,actual:e.actual,testId:this.testId,negative:e.negative||!1,runtime:A()-this.started,todo:!!this.todo}
if(E.call(e,"expected")&&(r.expected=e.expected),!e.result){var a=e.source||J()
a&&(r.source=a)}this.logAssertion(r),this.assertions.push({result:!!e.result,message:e.message})},pushFailure:function(e,t,n){if(!(this instanceof me))throw new Error("pushFailure() assertion outside test context, was "+J(2))
this.pushResult({result:!1,message:e||"error",actual:n||null,source:t})},logAssertion:function(e){se("log",e)
var t={passed:e.result,actual:e.actual,expected:e.expected,message:e.message,stack:e.source,todo:e.todo}
this.testReport.pushAssertion(t),re("assertion",t)},internalResetTimeout:function(e){l(M.timeout),M.timeout=s(M.timeoutHandler(e),e)},internalStop:function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:1
M.blocking=!0
...
a.remaining--,0===a.remaining&&n.pauses.delete(r),Ce(n)}}return n.pauses.set(r,a),s&&("number"==typeof n.timeout?t=n.timeout:"number"==typeof M.testTimeout&&(t=M.testTimeout),"number"==typeof t&&t>0&&(M.timeoutHandler=function(e){return function(){M.timeout=null,a.cancelled=!0,n.pauses.delete(r),n.pushFailure("Test took longer than ".concat(e,"ms; test timed out."),J(2)),Ce(n)}},l(M.timeout),M.timeout=s(M.timeoutHandler(t),t))),o},resolvePromise:function(e,t){if(null!=e){var n=this,r=e.then
if("function"===O(r)){var a=n.internalStop(),o=function(){a()}
M.notrycatch?r.call(e,o):r.call(e,o,(function(e){var r="Promise rejected "+(t?t.replace(/Each$/,""):"during")+' "'+n.testName+'": '+(e&&e.message||e)
n.pushFailure(r,K(e,0)),ve(),Ae(n)}))}}},valid:function(){var e=M.filter,t=/^(!?)\/([\w\W]*)\/(i?$)/.exec(e),n=M.module&&M.module.toLowerCase(),r=this.module.name+": "+this.testName
return!(!this.callback||!this.callback.validTest)||!(M.moduleId&&M.moduleId.length>0&&!function e(t){return T(t.moduleId,M.moduleId)||t.parentModule&&e(t.parentModule)}(this.module))&&!(M.testId&&M.testId.length>0&&!T(this.testId,M.testId))&&!(n&&!function e(t){return(t.name?t.name.toLowerCase():null)===n||!!t.parentModule&&e(t.parentModule)}(this.module))&&(!e||(t?this.regexFilter(!!t[1],t[2],t[3],r):this.stringFilter(e,r)))},regexFilter:function(e,t,n,r){return new RegExp(t,n).test(r)!==e},stringFilter:function(e,t){e=e.toLowerCase(),t=t.toLowerCase()
var n="!"!==e.charAt(0)
return n||(e=e.slice(1)),-1!==t.indexOf(e)?n:!n}}
var be=!1
function ye(e){be||M.currentModule.ignored||new me(e).queue()}function we(e){M.currentModule.ignored||(be||(M.queue.length=0,be=!0),new me(e).queue())}function De(e,t){ye({testName:e,callback:t})}function xe(e,t){return"".concat(e," [").concat(t,"]")}function Ee(e,t){if(Array.isArray(e))for(var n=0;n<e.length;n++)t(e[n],n)
else{if("object"!==f(e)||null===e)throw new Error("test.each() expects an array or object as input, but\nfound ".concat(f(e)," instead."))
for(var r in e)t(e[r],r)}}function Ae(e){e.pauses.forEach((function(e){e.cancelled=!0})),e.pauses.clear(),Ce(e)}function Ce(e){e.pauses.size>0||(s?(l(M.timeout),M.timeout=s((function(){e.pauses.size>0||(l(M.timeout),M.timeout=null,M.blocking=!1,fe.advance())}))):(M.blocking=!1,fe.advance()))}function ke(e){for(var t=[].concat(e.tests),n=b(e.childModules);n.length;){var r=n.shift()
t.push.apply(t,r.tests),n.push.apply(n,b(r.childModules))}return t}function Fe(e){return e.testsRun+e.testsIgnored===ke(e).length}function Te(e){for(e.testsIgnored++;e=e.parentModule;)e.testsIgnored++}_(De,{todo:function(e,t){ye({testName:e,callback:t,todo:!0})},skip:function(e){ye({testName:e,skip:!0})},only:function(e,t){we({testName:e,callback:t})},each:function(e,t,n){Ee(t,(function(t,r){ye({testName:xe(e,r),callback:n,withData:!0,stackOffset:5,data:t})}))}}),De.todo.each=function(e,t,n){Ee(t,(function(t,r){ye({testName:xe(e,r),callback:n,todo:!0,withData:!0,stackOffset:5,data:t})}))},De.skip.each=function(e,t){Ee(t,(function(t,n){ye({testName:xe(e,n),stackOffset:5,skip:!0})}))},De.only.each=function(e,t,n){Ee(t,(function(t,r){we({testName:xe(e,r),callback:n,withData:!0,stackOffset:5,data:t})}))}
var Ne,Re,_e,Oe,Se=function(){function e(t){var n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{}
h(this,e),this.log=n.log||Function.prototype.bind.call(i.log,i),t.on("error",this.onError.bind(this)),t.on("runStart",this.onRunStart.bind(this)),t.on("testStart",this.onTestStart.bind(this)),t.on("testEnd",this.onTestEnd.bind(this)),t.on("runEnd",this.onRunEnd.bind(this))}return g(e,[{key:"onError",value:function(e){this.log("error",e)}},{key:"onRunStart",value:function(e){this.log("runStart",e)}},{key:"onTestStart",value:function(e){this.log("testStart",e)}},{key:"onTestEnd",value:function(e){this.log("testEnd",e)}},{key:"onRunEnd",value:function(e){this.log("runEnd",e)}}],[{key:"init",value:function(t,n){return new e(t,n)}}]),e}(),Ie=!0
if("undefined"!=typeof process){var Pe=process.env
Ne=Pe.FORCE_COLOR,Re=Pe.NODE_DISABLE_COLORS,_e=Pe.NO_COLOR,Oe=Pe.TERM,Ie=process.stdout&&process.stdout.isTTY}var je={enabled:!Re&&null==_e&&"dumb"!==Oe&&(null!=Ne&&"0"!==Ne||Ie),reset:qe(0,0),bold:qe(1,22),dim:qe(2,22),italic:qe(3,23),underline:qe(4,24),inverse:qe(7,27),hidden:qe(8,28),strikethrough:qe(9,29),black:qe(30,39),red:qe(31,39),green:qe(32,39),yellow:qe(33,39),blue:qe(34,39),magenta:qe(35,39),cyan:qe(36,39),white:qe(37,39),gray:qe(90,39),grey:qe(90,39),bgBlack:qe(40,49),bgRed:qe(41,49),bgGreen:qe(42,49),bgYellow:qe(43,49),bgBlue:qe(44,49),bgMagenta:qe(45,49),bgCyan:qe(46,49),bgWhite:qe(47,49)}
...
return function(t){return void 0!==this&&void 0!==this.has?(~this.has.indexOf(e)||(this.has.push(e),this.keys.push(n)),void 0===t?this:je.enabled?Me(this.keys,t+""):t+""):void 0===t?((r={has:[e],keys:[n]}).reset=je.reset.bind(r),r.bold=je.bold.bind(r),r.dim=je.dim.bind(r),r.italic=je.italic.bind(r),r.underline=je.underline.bind(r),r.inverse=je.inverse.bind(r),r.hidden=je.hidden.bind(r),r.strikethrough=je.strikethrough.bind(r),r.black=je.black.bind(r),r.red=je.red.bind(r),r.green=je.green.bind(r),r.yellow=je.yellow.bind(r),r.blue=je.blue.bind(r),r.magenta=je.magenta.bind(r),r.cyan=je.cyan.bind(r),r.white=je.white.bind(r),r.gray=je.gray.bind(r),r.grey=je.grey.bind(r),r.bgBlack=je.bgBlack.bind(r),r.bgRed=je.bgRed.bind(r),r.bgGreen=je.bgGreen.bind(r),r.bgYellow=je.bgYellow.bind(r),r.bgBlue=je.bgBlue.bind(r),r.bgMagenta=je.bgMagenta.bind(r),r.bgCyan=je.bgCyan.bind(r),r.bgWhite=je.bgWhite.bind(r),r):je.enabled?Me([n],t+""):t+""
var r}}var Le=Object.prototype.hasOwnProperty
function Be(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:4
...
h(this,e),this.log=n.log||Function.prototype.bind.call(i.log,i),this.testCount=0,this.ended=!1,this.bailed=!1,t.on("error",this.onError.bind(this)),t.on("runStart",this.onRunStart.bind(this)),t.on("testEnd",this.onTestEnd.bind(this)),t.on("runEnd",this.onRunEnd.bind(this))}return g(e,[{key:"onRunStart",value:function(e){this.log("TAP version 13")}},{key:"onError",value:function(e){this.bailed||(this.bailed=!0,this.ended||(this.testCount=this.testCount+1,this.log(je.red("not ok ".concat(this.testCount," global failure"))),this.logError(e)),this.log("Bail out! "+P(e).split("\n")[0]),this.ended&&this.logError(e))}},{key:"onTestEnd",value:function(e){var t=this
...
n+="\n  message: ".concat(Be(e.message||"failed")),n+="\n  severity: ".concat(Be(t||"failed")),Le.call(e,"actual")&&(n+="\n  actual  : ".concat(Be(e.actual))),Le.call(e,"expected")&&(n+="\n  expected: ".concat(Be(e.expected))),e.stack&&(n+="\n  stack: ".concat(Be(e.stack+"\n"))),n+="\n  ...",this.log(n)}},{key:"logError",value:function(e){var t="  ---"
t+="\n  message: ".concat(Be(P(e))),t+="\n  severity: ".concat(Be("failed")),e&&e.stack&&(t+="\n  stack: ".concat(Be(e.stack+"\n"))),t+="\n  ...",this.log(t)}}],[{key:"init",value:function(t,n){return new e(t,n)}}]),e}(),Ve={console:Se,tap:He}
function ze(e){return function(t){M.globalHooks[e]||(M.globalHooks[e]=[]),M.globalHooks[e].push(t)}}var $e={beforeEach:ze("beforeEach"),afterEach:ze("afterEach")}
function We(e){M.current?M.current.assert.pushResult({result:!1,message:"global failure: ".concat(P(e)),source:e&&e.stack||J(2)}):(H.globalFailureCount++,M.stats.bad++,M.stats.all++,re("error",e))}var Ge={}
M.currentModule.suiteReport=H
var Ye=!1,Qe=!1
function Ke(){Qe=!0,s?s((function(){Xe()})):Xe()}function Je(){M.blocking=!1,fe.advance()}function Xe(){if(M.started)Je()
else{M.started=A(),""===M.modules[0].name&&0===M.modules[0].tests.length&&M.modules.shift()
for(var e=M.modules.length,t=[],n=0;n<e;n++)t.push({name:M.modules[n].name,tests:M.modules[n].tests})
re("runStart",H.start(!0)),se("begin",{totalTests:me.count,modules:t}).then(Je)}}Ge.isLocal=o&&o.location&&"file:"===o.location.protocol,Ge.version="2.18.1",_(Ge,{config:M,dump:L,equiv:j,reporters:Ve,hooks:$e,is:S,objectType:O,on:function(e,t){if("string"!==O(e))throw new TypeError("eventName must be a string when registering a listener")
if(!T(e,ne)){var n=ne.join(", ")
...
te[e]||(te[e]=[]),T(t,te[e])||te[e].push(t)},onError:function(e){if(D.warn("QUnit.onError is deprecated and will be removed in QUnit 3.0. Please use QUnit.onUncaughtException instead."),M.current&&M.current.ignoreGlobalErrors)return!0
var t=new Error(e.message)
return t.stack=e.stacktrace||e.fileName+":"+e.lineNumber,We(t),!1},onUncaughtException:We,pushFailure:ge,assert:X.prototype,module:Y,test:De,todo:De.todo,skip:De.skip,only:De.only,start:function(e){if(M.current)throw new Error("QUnit.start cannot be called inside a test context.")
var t=Ye
if(Ye=!0,Qe)throw new Error("Called start() while test already started running")
...
if(!M.pageLoaded)return M.autostart=!0,void(u||Ge.load())
Ke()},onUnhandledRejection:function(e){D.warn("QUnit.onUnhandledRejection is deprecated and will be removed in QUnit 3.0. Please use QUnit.onUncaughtException instead."),We(e)},extend:function(){D.warn("QUnit.extend is deprecated and will be removed in QUnit 3.0. Please use Object.assign instead.")
for(var e=arguments.length,t=new Array(e),n=0;n<e;n++)t[n]=arguments[n]
return _.apply(this,t)},load:function(){M.pageLoaded=!0,_(M,{started:0,updateRate:1e3,autostart:!0,filter:""},!0),Qe||(M.blocking=!1,M.autostart&&Ke())},stack:function(e){return J(e=(e||0)+2)}}),function(e){var t=["begin","done","log","testStart","testDone","moduleStart","moduleDone"]
...
"undefined"===O(M.callbacks[o])&&(M.callbacks[o]=[]),e[o]=n(o)}}(Ge),function(a){if(o&&u){if(o.QUnit&&o.QUnit.version)throw new Error("QUnit has already been defined.")
o.QUnit=a}e&&e.exports&&(e.exports=a,e.exports.QUnit=a),t&&(t.QUnit=a),void 0===(r=function(){return a}.call(t,n,t,e))||(e.exports=r),a.config.autostart=!1}(Ge),function(){if(o&&u){var e=Ge.config,t=Object.prototype.hasOwnProperty
Ge.begin((function(){if(!t.call(e,"fixture")){var n=u.getElementById("qunit-fixture")
n&&(e.fixture=n.cloneNode(!0))}})),Ge.testStart((function(){if(null!=e.fixture){var t=u.getElementById("qunit-fixture")
if("string"===f(e.fixture)){var n=u.createElement("div")
...
var Ze={exports:{}}
!function(e){var t,n
t=ae,n=function(){var e="undefined"==typeof window,t="function"==typeof Map?Map:function(){var e=Object.create(null)
...
a.total=0
var o=[],i=[]
function s(){n.clear(),r.clear(),o=[],i=[]}function l(e){for(var t=-9007199254740991,n=e.length-1;n>=0;--n){var r=e[n]
if(null!==r){var a=r.score
a>t&&(t=a)}}return-9007199254740991===t?null:t}function u(e,t){var n=e[t]
if(void 0!==n)return n
var r=t
...
return e[0]=e[--t],r(),n}},n.peek=function(n){if(0!==t)return e[0]},n.replaceTop=function(t){e[0]=t,r()},n},p=d()
return function t(f){var h={single:function(e,t,n){return"farzher"==e?{target:"farzher was here (^-^*)/",score:0,indexes:[0,1,2,3,4,5,6]}:e?(c(e)||(e=h.getPreparedSearch(e)),t?(c(t)||(t=h.getPrepared(t)),((n&&void 0!==n.allowTypo?n.allowTypo:!f||void 0===f.allowTypo||f.allowTypo)?h.algorithm:h.algorithmNoTypo)(e,t,e[0])):null):null},go:function(e,t,n){if("farzher"==e)return[{target:"farzher was here (^-^*)/",score:0,indexes:[0,1,2,3,4,5,6],obj:t?t[0]:null}]
if(!e)return a
var r=(e=h.prepareSearch(e))[0],o=n&&n.threshold||f&&f.threshold||-9007199254740991,i=n&&n.limit||f&&f.limit||9007199254740991,s=(n&&void 0!==n.allowTypo?n.allowTypo:!f||void 0===f.allowTypo||f.allowTypo)?h.algorithm:h.algorithmNoTypo,d=0,m=0,g=t.length
if(n&&n.keys)for(var v=n.scoreFn||l,b=n.keys,y=b.length,w=g-1;w>=0;--w){for(var D=t[w],x=new Array(y),E=y-1;E>=0;--E)(k=u(D,C=b[E]))?(c(k)||(k=h.getPrepared(k)),x[E]=s(e,k,r)):x[E]=null
x.obj=D
var A=v(x)
null!==A&&(A<o||(x.score=A,d<i?(p.add(x),++d):(++m,A>p.peek().score&&p.replaceTop(x))))}else if(n&&n.key){var C=n.key
for(w=g-1;w>=0;--w)(k=u(D=t[w],C))&&(c(k)||(k=h.getPrepared(k)),null!==(F=s(e,k,r))&&(F.score<o||(F={target:F.target,_targetLowerCodes:null,_nextBeginningIndexes:null,score:F.score,indexes:F.indexes,obj:D},d<i?(p.add(F),++d):(++m,F.score>p.peek().score&&p.replaceTop(F)))))}else for(w=g-1;w>=0;--w){var k,F;(k=t[w])&&(c(k)||(k=h.getPrepared(k)),null!==(F=s(e,k,r))&&(F.score<o||(d<i?(p.add(F),++d):(++m,F.score>p.peek().score&&p.replaceTop(F)))))}if(0===d)return a
var T=new Array(d)
for(w=d-1;w>=0;--w)T[w]=p.poll()
return T.total=d+m,T},goAsync:function(t,n,r){var o=!1,i=new Promise((function(i,s){if("farzher"==t)return i([{target:"farzher was here (^-^*)/",score:0,indexes:[0,1,2,3,4,5,6],obj:n?n[0]:null}])
if(!t)return i(a)
var p=(t=h.prepareSearch(t))[0],m=d(),g=n.length-1,v=r&&r.threshold||f&&f.threshold||-9007199254740991,b=r&&r.limit||f&&f.limit||9007199254740991,y=(r&&void 0!==r.allowTypo?r.allowTypo:!f||void 0===f.allowTypo||f.allowTypo)?h.algorithm:h.algorithmNoTypo,w=0,D=0
function x(){if(o)return s("canceled")
var d=Date.now()
if(r&&r.keys)for(var f=r.scoreFn||l,E=r.keys,A=E.length;g>=0;--g){if(g%1e3==0&&Date.now()-d>=10)return void(e?setImmediate(x):setTimeout(x))
for(var C=n[g],k=new Array(A),F=A-1;F>=0;--F)(R=u(C,N=E[F]))?(c(R)||(R=h.getPrepared(R)),k[F]=y(t,R,p)):k[F]=null
k.obj=C
var T=f(k)
null!==T&&(T<v||(k.score=T,w<b?(m.add(k),++w):(++D,T>m.peek().score&&m.replaceTop(k))))}else if(r&&r.key)for(var N=r.key;g>=0;--g){if(g%1e3==0&&Date.now()-d>=10)return void(e?setImmediate(x):setTimeout(x));(R=u(C=n[g],N))&&(c(R)||(R=h.getPrepared(R)),null!==(_=y(t,R,p))&&(_.score<v||(_={target:_.target,_targetLowerCodes:null,_nextBeginningIndexes:null,score:_.score,indexes:_.indexes,obj:C},w<b?(m.add(_),++w):(++D,_.score>m.peek().score&&m.replaceTop(_)))))}else for(;g>=0;--g){if(g%1e3==0&&Date.now()-d>=10)return void(e?setImmediate(x):setTimeout(x))
var R,_;(R=n[g])&&(c(R)||(R=h.getPrepared(R)),null!==(_=y(t,R,p))&&(_.score<v||(w<b?(m.add(_),++w):(++D,_.score>m.peek().score&&m.replaceTop(_)))))}if(0===w)return i(a)
for(var O=new Array(w),S=w-1;S>=0;--S)O[S]=m.poll()
O.total=w+D,i(O)}e?setImmediate(x):x()}))
...
var t=r.get(e)
return void 0!==t||(t=h.prepareSearch(e),r.set(e,t)),t},algorithm:function(e,t,n){for(var r=t._targetLowerCodes,a=e.length,s=r.length,l=0,u=0,c=0,d=0;;){if(n===r[u]){if(o[d++]=u,++l===a)break
n=e[0===c?l:c===l?l+1:c===l-1?l-1:l]}if(++u>=s)for(;;){if(l<=1)return null
if(0===c){if(n===e[--l])continue
c=l}else{if(1===c)return null
if((n=e[1+(l=--c)])===e[l])continue}u=o[(d=l)-1]+1
break}}l=0
var p=0,f=!1,m=0,g=t._nextBeginningIndexes
null===g&&(g=t._nextBeginningIndexes=h.prepareNextBeginningIndexes(t.target))
var v=u=0===o[0]?0:g[o[0]-1]
if(u!==s)for(;;)if(u>=s){if(l<=0){if(++p>a-2)break
if(e[p]===e[p+1])continue
u=v
continue}--l,u=g[i[--m]]}else if(e[0===p?l:p===l?l+1:p===l-1?l-1:l]===r[u]){if(i[m++]=u,++l===a){f=!0
break}++u}else u=g[u]
if(f)var b=i,y=m
else b=o,y=d
for(var w=0,D=-1,x=0;x<a;++x)D!==(u=b[x])-1&&(w-=u),D=u
for(f?0!==p&&(w+=-20):(w*=1e3,0!==c&&(w+=-20)),w-=s-a,t.score=w,t.indexes=new Array(y),x=y-1;x>=0;--x)t.indexes[x]=b[x]
return t},algorithmNoTypo:function(e,t,n){for(var r=t._targetLowerCodes,a=e.length,s=r.length,l=0,u=0,c=0;;){if(n===r[u]){if(o[c++]=u,++l===a)break
n=e[l]}if(++u>=s)return null}l=0
var d=!1,p=0,f=t._nextBeginningIndexes
if(null===f&&(f=t._nextBeginningIndexes=h.prepareNextBeginningIndexes(t.target)),(u=0===o[0]?0:f[o[0]-1])!==s)for(;;)if(u>=s){if(l<=0)break;--l,u=f[i[--p]]}else if(e[l]===r[u]){if(i[p++]=u,++l===a){d=!0
break}++u}else u=f[u]
if(d)var m=i,g=p
else m=o,g=c
...
return h}()},e.exports?e.exports=n():t.fuzzysort=n()}(Ze)
var et=Ze.exports,tt={failedTests:[],defined:0,completed:0}
function nt(e){return e?(e+="").replace(/['"<>&]/g,(function(e){switch(e){case"'":return"&#039;"
case'"':return"&quot;"
case"<":return"&lt;"
case">":return"&gt;"
case"&":return"&amp;"}})):""}!function(){if(o&&u){var e=Ge.config,t=[],n=!1,r=Object.prototype.hasOwnProperty,a=C({filter:void 0,module:void 0,moduleId:void 0,testId:void 0})
Ge.on("runStart",(function(e){tt.defined=e.testCounts.total})),Ge.begin((function(){var t,n,i,s,l,d,p,g,y,C,T;(d=D("qunit"))&&(d.setAttribute("role","main"),d.innerHTML="<h1 id='qunit-header'>"+nt(u.title)+"</h1><h2 id='qunit-banner'></h2><div id='qunit-testrunner-toolbar' role='navigation'></div>"+(!(t=Ge.config.testId)||t.length<=0?"":"<div id='qunit-filteredTest'>Rerunning selected tests: "+nt(t.join(", "))+" <a id='qunit-clearFilter' href='"+nt(a)+"'>Run all tests</a></div>")+"<h2 id='qunit-userAgent'></h2><ol id='qunit-tests'></ol>"),(n=D("qunit-header"))&&(n.innerHTML="<a href='"+nt(a)+"'>"+n.innerHTML+"</a> "),(i=D("qunit-banner"))&&(i.className=""),C=D("qunit-tests"),(T=D("qunit-testresult"))&&T.parentNode.removeChild(T),C&&(C.innerHTML="",(T=u.createElement("p")).id="qunit-testresult",T.className="result",C.parentNode.insertBefore(T,C),T.innerHTML='<div id="qunit-testresult-display">Running...<br />&#160;</div><div id="qunit-testresult-controls"></div><div class="clearfix"></div>',g=D("qunit-testresult-controls")),g&&g.appendChild(((y=u.createElement("button")).id="qunit-abort-tests-button",y.innerHTML="Abort",f(y,"click",x),y)),(s=D("qunit-userAgent"))&&(s.innerHTML="",s.appendChild(u.createTextNode("QUnit "+Ge.version+"; "+c.userAgent))),(l=D("qunit-testrunner-toolbar"))&&(l.appendChild(((p=u.createElement("span")).innerHTML=function(){for(var t=!1,n=e.urlConfig,a="",o=0;o<n.length;o++){var i=e.urlConfig[o]
"string"==typeof i&&(i={id:i,label:i})
var s=nt(i.id),l=nt(i.tooltip)
if(i.value&&"string"!=typeof i.value){if(a+="<label for='qunit-urlconfig-"+s+"' title='"+l+"'>"+i.label+": </label><select id='qunit-urlconfig-"+s+"' name='"+s+"' title='"+l+"'><option></option>",Array.isArray(i.value))for(var u=0;u<i.value.length;u++)a+="<option value='"+(s=nt(i.value[u]))+"'"+(e[i.id]===i.value[u]?(t=!0)&&" selected='selected'":"")+">"+s+"</option>"
else for(var c in i.value)r.call(i.value,c)&&(a+="<option value='"+nt(c)+"'"+(e[i.id]===c?(t=!0)&&" selected='selected'":"")+">"+nt(i.value[c])+"</option>")
e[i.id]&&!t&&(a+="<option value='"+(s=nt(e[i.id]))+"' selected='selected' disabled='disabled'>"+s+"</option>"),a+="</select>"}else a+="<label for='qunit-urlconfig-"+s+"' title='"+l+"'><input id='qunit-urlconfig-"+s+"' name='"+s+"' type='checkbox'"+(i.value?" value='"+nt(i.value)+"'":"")+(e[i.id]?" checked='checked'":"")+" title='"+l+"' />"+nt(i.label)+"</label>"}return a}(),v(p,"qunit-url-config"),m(p.getElementsByTagName("input"),"change",A),m(p.getElementsByTagName("select"),"change",A),p)),l.appendChild(function(){var t,n,r,a,i=u.createElement("span")
return i.id="qunit-toolbar-filters",i.appendChild((t=u.createElement("form"),n=u.createElement("label"),r=u.createElement("input"),a=u.createElement("button"),v(t,"qunit-filter"),n.innerHTML="Filter: ",r.type="text",r.value=e.filter||"",r.name="filter",r.id="qunit-filter-input",a.innerHTML="Go",n.appendChild(r),t.appendChild(n),t.appendChild(u.createTextNode(" ")),t.appendChild(a),f(t,"submit",E),t)),i.appendChild(function(){var t=u.createElement("form"),n=u.createElement("label"),r=u.createElement("input"),a=u.createElement("div"),i=u.createElement("span"),s=u.createElement("button"),l=u.createElement("button"),c=u.createElement("label"),d=u.createElement("input"),p=u.createElement("ul"),m=!1
r.id="qunit-modulefilter-search",r.autocomplete="off",f(r,"input",x),f(r,"input",D),f(r,"focus",D),f(r,"click",D),e.modules.forEach((function(e){e.namePrepared=et.prepare(e.name)})),n.id="qunit-modulefilter-search-container",n.innerHTML="Module: ",n.appendChild(r),s.textContent="Apply",s.style.display="none",l.textContent="Reset",l.type="reset",l.style.display="none",d.type="checkbox",d.checked=0===e.moduleId.length,c.className="clickable",e.moduleId.length&&(c.className="checked"),c.appendChild(d),c.appendChild(u.createTextNode("All modules")),i.id="qunit-modulefilter-actions",i.appendChild(s),i.appendChild(l),i.appendChild(c)
var g,v=i.firstChild,y=v.nextSibling
function D(){function e(n){var o=t.contains(n.target)
27!==n.keyCode&&o||(27===n.keyCode&&o&&r.focus(),a.style.display="none",h(u,"click",e),h(u,"keydown",e),r.value="",x())}"none"===a.style.display&&(a.style.display="block",f(u,"click",e),f(u,"keydown",e))}function x(){o.clearTimeout(g),g=o.setTimeout((function(){var t,n=""===(t=r.value.toLowerCase())?e.modules:et.go(t,e.modules,{key:"namePrepared",threshold:-1e4}).map((function(e){return e.obj}))
p.innerHTML=F(n)}),200)}function A(e){var t=e&&e.target||d,n=p.getElementsByTagName("input"),a=[]
b(t.parentNode,"checked",t.checked),m=!1,t.checked&&t!==d&&(d.checked=!1,w(d.parentNode,"checked"))
for(var o=0;o<n.length;o++){var i=n[o]
e?t===d&&t.checked&&(i.checked=!1,w(i.parentNode,"checked")):b(i.parentNode,"checked",i.checked),m=m||i.checked!==i.defaultChecked,i.checked&&a.push(i.parentNode.textContent)}v.style.display=y.style.display=m?"":"none",r.placeholder=a.join(", ")||d.parentNode.textContent,r.title="Type to filter list. Current selection:\n"+(a.join("\n")||d.parentNode.textContent)}return f(v,"click",k),p.id="qunit-modulefilter-dropdown-list",p.innerHTML=F(e.modules),a.id="qunit-modulefilter-dropdown",a.style.display="none",a.appendChild(i),a.appendChild(p),f(a,"change",A),A(),t.id="qunit-modulefilter",t.appendChild(n),t.appendChild(a),f(t,"submit",E),f(t,"reset",(function(){o.setTimeout(A)})),t}()),i}()),l.appendChild(u.createElement("div")).className="clearfix")})),Ge.on("runEnd",(function(t){var n,r,a,i=D("qunit-banner"),s=D("qunit-tests"),l=D("qunit-abort-tests-button"),c=e.stats.all-e.stats.bad,d=[t.testCounts.total," tests completed in ",t.runtime," milliseconds, with ",t.testCounts.failed," failed, ",t.testCounts.skipped," skipped, and ",t.testCounts.todo," todo.<br />","<span class='passed'>",c,"</span> assertions of <span class='total'>",e.stats.all,"</span> passed, <span class='failed'>",e.stats.bad,"</span> failed.",N(tt.failedTests)].join("")
if(l&&l.disabled){d="Tests aborted after "+t.runtime+" milliseconds."
for(var p=0;p<s.children.length;p++)""!==(n=s.children[p]).className&&"running"!==n.className||(n.className="aborted",a=n.getElementsByTagName("ol")[0],(r=u.createElement("li")).className="fail",r.innerHTML="Test aborted.",a.appendChild(r))}!i||l&&!1!==l.disabled||(i.className="failed"===t.status?"qunit-fail":"qunit-pass"),l&&l.parentNode.removeChild(l),s&&(D("qunit-testresult-display").innerHTML=d),e.altertitle&&u.title&&(u.title=["failed"===t.status?"✖":"✔",u.title.replace(/^[\u2714\u2716] /i,"")].join(" ")),e.scrolltop&&o.scrollTo&&o.scrollTo(0,0)})),Ge.testStart((function(e){var t,n
T(e.name,e.testId,e.module),(t=D("qunit-testresult-display"))&&(v(t,"running"),n=Ge.config.reorder&&e.previousFailure,t.innerHTML=[O(tt),n?"Rerunning previously failed test: <br />":"Running: ",R(e.name,e.module),N(tt.failedTests)].join(""))})),Ge.log((function(e){var t=D("qunit-test-output-"+e.testId)
if(t){var n,a,o,i=nt(e.message)||(e.result?"okay":"failed")
i="<span class='test-message'>"+i+"</span>",i+="<span class='runtime'>@ "+e.runtime+" ms</span>"
var s=!1
!e.result&&r.call(e,"expected")?(n=e.negative?"NOT "+Ge.dump.parse(e.expected):Ge.dump.parse(e.expected),a=Ge.dump.parse(e.actual),i+="<table><tr class='test-expected'><th>Expected: </th><td><pre>"+nt(n)+"</pre></td></tr>",a!==n?(i+="<tr class='test-actual'><th>Result: </th><td><pre>"+nt(a)+"</pre></td></tr>","number"==typeof e.actual&&"number"==typeof e.expected?isNaN(e.actual)||isNaN(e.expected)||(s=!0,o=((o=e.actual-e.expected)>0?"+":"")+o):"boolean"!=typeof e.actual&&"boolean"!=typeof e.expected&&(s=S(o=Ge.diff(n,a)).length!==S(n).length+S(a).length),s&&(i+="<tr class='test-diff'><th>Diff: </th><td><pre>"+o+"</pre></td></tr>")):-1!==n.indexOf("[object Array]")||-1!==n.indexOf("[object Object]")?i+="<tr class='test-message'><th>Message: </th><td>Diff suppressed as the depth of object is more than current max depth ("+Ge.config.maxDepth+").<p>Hint: Use <code>QUnit.dump.maxDepth</code> to  run with a higher max depth or <a href='"+nt(C({maxDepth:-1}))+"'>Rerun</a> without max depth.</p></td></tr>":i+="<tr class='test-message'><th>Message: </th><td>Diff suppressed as the expected and actual results have an equivalent serialization</td></tr>",e.source&&(i+="<tr class='test-source'><th>Source: </th><td><pre>"+nt(e.source)+"</pre></td></tr>"),i+="</table>"):!e.result&&e.source&&(i+="<table><tr class='test-source'><th>Source: </th><td><pre>"+nt(e.source)+"</pre></td></tr></table>")
var l=t.getElementsByTagName("ol")[0],c=u.createElement("li")
c.className=e.result?"pass":"fail",c.innerHTML=i,l.appendChild(c)}})),Ge.testDone((function(r){var a=D("qunit-tests"),o=D("qunit-test-output-"+r.testId)
if(a&&o){var i
w(o,"running"),i=r.failed>0?"failed":r.todo?"todo":r.skipped?"skipped":"passed"
var s=o.getElementsByTagName("ol")[0],l=r.passed,c=r.failed,d=r.failed>0?r.todo:!r.todo
d?v(s,"qunit-collapsed"):(tt.failedTests.push(r.testId),e.collapse&&(n?v(s,"qunit-collapsed"):n=!0))
var p=o.firstChild,h=c?"<b class='failed'>"+c+"</b>, <b class='passed'>"+l+"</b>, ":""
if(p.innerHTML+=" <b class='counts'>("+h+r.assertions.length+")</b>",tt.completed++,r.skipped){o.className="skipped"
var m=u.createElement("em")
m.className="qunit-skipped-label",m.innerHTML="skipped",o.insertBefore(m,p)}else{if(f(p,"click",(function(){b(s,"qunit-collapsed")})),o.className=d?"pass":"fail",r.todo){var g=u.createElement("em")
g.className="qunit-todo-label",g.innerHTML="todo",o.className+=" todo",o.insertBefore(g,p)}var y=u.createElement("span")
y.className="runtime",y.innerHTML=r.runtime+" ms",o.insertBefore(y,s)}if(r.source){var x=u.createElement("p")
x.innerHTML="<strong>Source: </strong>"+nt(r.source),v(x,"qunit-source"),d&&v(x,"qunit-collapsed"),f(p,"click",(function(){b(x,"qunit-collapsed")})),o.appendChild(x)}e.hidepassed&&("passed"===i||r.skipped)&&(t.push(o),a.removeChild(o))}})),Ge.on("error",(function(e){var t=T("global failure")
if(t){var n=nt(P(e))
n="<span class='test-message'>"+n+"</span>",e&&e.stack&&(n+="<table><tr class='test-source'><th>Source: </th><td><pre>"+nt(e.stack)+"</pre></td></tr></table>")
var r=t.getElementsByTagName("ol")[0],a=u.createElement("li")
a.className="fail",a.innerHTML=n,r.appendChild(a),t.className="fail"}}))
var s,l=(s=o.phantom)&&s.version&&s.version.major>0
l&&i.warn("Support for PhantomJS is deprecated and will be removed in QUnit 3.0."),l||"complete"!==u.readyState?f(o,"load",Ge.load):Ge.load()
var d=o.onerror
o.onerror=function(t,n,r,a,o){var i=!1
if(d){for(var s=arguments.length,l=new Array(s>5?s-5:0),u=5;u<s;u++)l[u-5]=arguments[u]
i=d.call.apply(d,[this,t,n,r,a,o].concat(l))}if(!0!==i){if(e.current&&e.current.ignoreGlobalErrors)return!0
var c=o||new Error(t)
!c.stack&&n&&r&&(c.stack="".concat(n,":").concat(r)),Ge.onUncaughtException(c)}return i},o.addEventListener("unhandledrejection",(function(e){Ge.onUncaughtException(e.reason)}))}function p(e){return"function"==typeof e.trim?e.trim():e.replace(/^\s+|\s+$/g,"")}function f(e,t,n){e.addEventListener(t,n,!1)}function h(e,t,n){e.removeEventListener(t,n,!1)}function m(e,t,n){for(var r=e.length;r--;)f(e[r],t,n)}function g(e,t){return(" "+e.className+" ").indexOf(" "+t+" ")>=0}function v(e,t){g(e,t)||(e.className+=(e.className?" ":"")+t)}function b(e,t,n){n||void 0===n&&!g(e,t)?v(e,t):w(e,t)}function w(e,t){for(var n=" "+e.className+" ";n.indexOf(" "+t+" ")>=0;)n=n.replace(" "+t+" "," ")
e.className=p(n)}function D(e){return u.getElementById&&u.getElementById(e)}function x(){var e=D("qunit-abort-tests-button")
return e&&(e.disabled=!0,e.innerHTML="Aborting..."),Ge.config.queue.length=0,!1}function E(e){var t=D("qunit-filter-input")
return t.value=p(t.value),k(),e&&e.preventDefault&&e.preventDefault(),!1}function A(){var n,r=this,a={}
n="selectedIndex"in r?r.options[r.selectedIndex].value||void 0:r.checked?r.defaultValue||!0:void 0,a[r.name]=n
var i=C(a)
if("hidepassed"===r.name&&"replaceState"in o.history){Ge.urlParams[r.name]=n,e[r.name]=n||!1
var s=D("qunit-tests")
if(s){var l=s.children.length,u=s.children
if(r.checked){for(var c=0;c<l;c++){var d=u[c],p=d?d.className:"",f=p.indexOf("pass")>-1,h=p.indexOf("skipped")>-1;(f||h)&&t.push(d)}var m,g=function(e,t){var n="undefined"!=typeof Symbol&&e[Symbol.iterator]||e["@@iterator"]
...
s.removeChild(v)}}catch(e){g.e(e)}finally{g.f()}}else for(var b;null!=(b=t.pop());)s.appendChild(b)}o.history.replaceState(null,"",i)}else o.location=i}function C(e){var t="?",n=o.location
for(var a in e=_(_({},Ge.urlParams),e))if(r.call(e,a)&&void 0!==e[a])for(var i=[].concat(e[a]),s=0;s<i.length;s++)t+=encodeURIComponent(a),!0!==i[s]&&(t+="="+encodeURIComponent(i[s])),t+="&"
return n.protocol+"//"+n.host+n.pathname+t.slice(0,-1)}function k(){var e,t=[],n=D("qunit-modulefilter-dropdown-list").getElementsByTagName("input"),r=D("qunit-filter-input").value
for(e=0;e<n.length;e++)n[e].checked&&t.push(n[e].value)
o.location=C({filter:""===r?void 0:r,moduleId:0===t.length?void 0:t,module:void 0,testId:void 0})}function F(t){for(var n="",r=0;r<t.length;r++)if(""!==t[r].name){var a=e.moduleId.indexOf(t[r].moduleId)>-1
n+="<li><label class='clickable"+(a?" checked":"")+"'><input type='checkbox' value='"+t[r].moduleId+"'"+(a?" checked='checked'":"")+" />"+nt(t[r].name)+"</label></li>"}return n}function T(e,t,n){var r=D("qunit-tests")
if(r){var a=u.createElement("strong")
a.innerHTML=R(e,n)
var o=u.createElement("li")
if(o.appendChild(a),void 0!==t){var i=u.createElement("a")
i.innerHTML="Rerun",i.href=C({testId:t}),o.id="qunit-test-output-"+t,o.appendChild(i)}var s=u.createElement("ol")
return s.className="qunit-assert-list",o.appendChild(s),r.appendChild(o),o}}function N(e){return 0===e.length?"":["<br /><a href='"+nt(C({testId:e}))+"'>",1===e.length?"Rerun 1 failed test":"Rerun "+e.length+" failed tests","</a>"].join("")}function R(e,t){var n=""
return t&&(n="<span class='module-name'>"+nt(t)+"</span>: "),n+"<span class='test-name'>"+nt(e)+"</span>"}function O(e){return[e.completed," / ",e.defined," tests completed.<br />"].join("")}function S(e){return e.replace(/<\/?[^>]+(>|$)/g,"").replace(/&quot;/g,"").replace(/\s+/g,"")}}(),Ge.diff=function(){function e(){}var t=-1,n=Object.prototype.hasOwnProperty
...
switch(a){case 1:n[r]="<ins>"+nt(o)+"</ins>"
break
case t:n[r]="<del>"+nt(o)+"</del>"
break
case 0:n[r]="<span>"+nt(o)+"</span>"}}return n.join("")},e.prototype.diffCommonPrefix=function(e,t){var n,r,a,o
